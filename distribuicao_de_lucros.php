...
<h2 style="float: left">Distribuição de Lucros</h2>
...
<br>
<br>
<h2>Calcule do teto   para distribuição de lucros de sua empresa:</h2>
<br>
...
while($dados = mysql_fetch_array($query)){
	...
	echo "	<!--<div style=\"position:relative;float:left;padding:5px;width:20px;\"><input type=\"checkbox\" name=\"idSocio[]\" value=\"".$dados['idSocio']."\"></div>" . "\r\n" . "-->
					<div style=\"position:relative;float:left;padding:5px 5px 5px 0;width:150px;\" class=\"txtNomeSocio\">".$dados['nome']."</div>" . "\r\n" . "
...
//					$('#resultado').html(result);
  ...
  <H2 style="margin-top: 5px; margin-bottom: 10px">Pagamentos efetuados</H2>
...
<?
	...
	?>
      ...
      <table width="98.8%" cellpadding="5" style="margin-bottom:25px;">
          <tr>
            <th width="7%">Ação</th>
            <th width="45%">Nome</th>
            <th width="15%">Tipo</th>
