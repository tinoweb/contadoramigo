...
<div class="principal minHeight">
	...
	<span class="titulo">Impostos e Obrigações</span>
	<br /><br />
	
	<div class="tituloVermelho" style="margin-bottom:20px">Apuração do Simples</div>

	<div class="quadro_passos" style="display: table;">
		
		<form id="formPergunta" action="simples_orientacoes_retencao.php" method="post">
