...
/* *** CABECALHO *** */
#instr_header {
	/*background: url('https://www.contadoramigo.com.br/images/bb_logo.png') no-repeat top left;*/
	/*padding-left: 160px;*/
	height: 65px;
}
#instr_header h1 {
...
<div id="container">
	...
	<div id="instr_header">
		<img class="logo_aparecer" src="images/logo.png" alt="Contador Amigo" width="198" height="34" border="0" style="float:left;display:none">
...
do Sacado</b></div></TD></tr></tbody></table>
		...
		<tbody>
		<tr>
			<td width=150><IMG SRC="images/bb_logobb.jpg"></td>
			<td width=50>
