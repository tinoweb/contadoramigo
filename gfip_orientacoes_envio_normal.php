...
<!--BALLOM Sefip -->
<!-- <div style="width:310px; position:absolute; margin-left:260px; margin-top:160px; display:none" id="sefip">
...
<a class="linkMenu" style="font-size:10px" href="javascript:abreDivFechaOutro('passo13','passo1')"> <img src="images/retroceder_azul.png" width="7" height="8" border=0 alt="Voltar" /> <strong>ANTERIOR</strong>&nbsp;&nbsp;&nbsp; </a>
<span class="tituloVermelho">Passo 1 de 13</span> 
...
<div>
	...
	<ul>
		<li>Localize em seu micro o programa Sefip e abra-o.</li>
		<li>No Sefip, atualize as tabelas de cálculo clicando em <strong>Ferramentas</strong> / <strong>Carga Manual de Tabelas</strong> / <strong>Auxiliares - INSS</strong> / <strong>Automático</strong>. As tabelas auxiliares devem ser atualizadas sempre que o governo corrigir o salário mínimo e os tetos dos salários de contribuição. Na dúvida, atualize. Se aparecer a mensagem &quot;Não existe tabela auxiliar atualizada para captura&quot;. É porque você já está com a tabela mais recente.<br /></li>
	</ul>
</div>
<img src="images/sefip_new.png" width="90%" height="60%" /><br /><br />

 <!--BALLOM tabela -->
<div style="width:310px; position:absolute; top:320px; left:50%; margin-left:200px; display:none" id="tabela">
<div style="width:8px; position:absolute; margin-left:280px; margin-top:12px; background-color:#FF9"><a href="javascript:fechaDiv('tabela')"><img src="images/x.png" width="8" height="9" border="0" /></a></div>
  ...
  <table cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
      <td background="images/balloon_fundo_esq.png" valign="top" width="18"><img src="images/ballon_ponta.png" width="18" height="58" /></td>
      <td width="285" bgcolor="#FFFF99" valign="top"><div style="width:245px; margin-left:20px; font-size:12px">
      <strong>ATENÇÃO:</strong>      as tabelas do INSS são alteradas todo  início do ano. Se você recolhe o INSS pelo teto precisa atualizar as tabelas no Sefip para que a GPS saia com o valor atualizado.
</div></td>
      <td background="images/balloon_fundo_dir.png" width="7"></td>
    </tr>
    <tr>
...
<span class="tituloVermelho">Passo 2 de 13</span> 
...
<div>
	No menu principal, clique em<strong> Arquivo / Importar Folha</strong>.<br /><br />
</div>
<img src="images/sefip_importar.png" width="75%" height="60%" /><br /><br />
</div>
...
<span class="tituloVermelho">Passo 3 de 13</span> 
...
<div>
	Localize o arquivo <strong>sefip.re</strong> que você baixou para seu computador e clique em <strong>Abrir</strong>. Atenção: O nome do arquivo deve estar como "sefip.re", do contrário você não conseguirá importá-lo. Ao importar a Folha, aparecerá um alerta: "O movimento atual será fechado. Todos os dados serão excluídos. confirma?". Pode confirmar sem medo.
<br /><br />
</div>

<img src="images/sefip_importar2.png" width="75%" height="30%" /><br /><br />
</div>
...
<span class="tituloVermelho">Passo 4 de 13</span> 
...
<span class="tituloVermelho">Passo 5 de 13</span> 
...
<div>
	Clique no botão [...] do campo <strong>Caminho</strong> e escolha uma pasta para guardar seu  Gfip. <strong>Atenção: não salve no local sugerido pelo programa, você não conseguirá encontrá-lo</strong>. Selecione, ao invés disso, a pasta Área de Trabalho, clique ok e <strong>Salve</strong>. Algumas janelas de confirmação e alerta aparecerão, clique ok. Pronto, o arquivo da Gfip está criado e salvo em seu computador.<br /><br />
</div>
...
<span class="tituloVermelho">Passo 6 de 13</span> 
...
<span class="tituloVermelho">Passo 7 de 13</span> 
...
<span class="tituloVermelho">Passo 8 de 13</span> 
...
<img src="images/conectividade_sefip.png" width="90%" height="70%" /><br /><br />
</div> 
...
<span class="tituloVermelho">Passo 9 de 13</span> 
...
<span class="tituloVermelho">Passo 10 de 13</span> 
...
<span class="tituloVermelho">Passo 11 de 13</span> 
...
<div>
	Agora, você deverá enviar o arquivo zip da mensagem que acabou de salvar. Clique no botão <strong>Procurar</strong> e localize-o em seu micro. Em seguida, clique no botão <strong>Enviar</strong>.<br /><br />
</div>
...
<span class="tituloVermelho">Passo 12 de 13</span> 
...
<img src="images/conectividade_protocolo.png" width="90%" height="85%" />
</div>
...
<span class="tituloVermelho">Passo 13 de 13</span> 
<a class="linkMenu" style="font-size:10px" href="javascript:abreDivFechaOutro('passo1','passo13')">&nbsp;&nbsp;&nbsp;<strong>PRÓXIMO</strong> <img src="images/avancar_azul.png" width="7" height="8" border=0 alt="Avançar" /> </a><br />
<br /> 
<div>
