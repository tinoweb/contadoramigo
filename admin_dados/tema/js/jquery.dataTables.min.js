...
var mParameter = getUrlParameters("m",document.URL, true);
if(mParameter == 'estagio_obra'){
	var var_filtro = 'Filtrar por Empreendimento:';
}else{
	var var_filtro = 'Filtrar:';
}
	...
	var L = function(h) {
			...
			this.oApi = {
				...
				_fnCreateCookie: function(a, b, c, d, e) {
					...
					null !== e ? (g = "function" === typeof h.parseJSON ? h.parseJSON(b) : eval("(" + b + ")"),
						b = e(a, g, f.toGMTString(), c.join("../../../index.html") + "/")) : b = a + "=" + encodeURIComponent(b) + "; expires=" + f.toGMTString() + "; path=" + c.join("../../../index.html") + "/";
					a = l.cookie.split(";");
					e = b.split(";")[0].length;
					f = [];
					if (4096 < e + l.cookie.length + 10) {
						...
						for (f.sort(function(a, b) {
							...
							d = f.pop();
							l.cookie =
								d.name + "=; expires=Thu, 01-Jan-1970 00:00:01 GMT; path=" + c.join("../../../index.html") + "/"
						}
					}
					l.cookie = b
				},
				_fnReadCookie: function(a) {
					for (var b = X.location.pathname.split("../../../index.html"), a = a + "_" + b[b.length - 1].replace(/[\/:]/g, "").toLowerCase() + "=", b = l.cookie.split(";"), c = 0; c < b.length; c++) {
						for (var d = b[c];
		...
		j.defaults = {
			...
			oLanguage: {
				...
				sEmptyTable: "Ainda não há dados para exibir.",
				...
				sSearch: var_filtro,
				sUrl: "",
				sZeroRecords: "Nenhum registro encontrado com essa especificação."
			},
