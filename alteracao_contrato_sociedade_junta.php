<?php 
	...
	// inclui o arquivo para verificar pegar os dados do login.
	require_once('DataBaseMySQL/DadosCobranca.php');
	
	$dadosCobranca = new DadosCobranca();
	
	$dados = $dadosCobranca->pegaDadosCobranca($_SESSION["id_userSecao"]);
?>

<div class="principal">
<div class="minHeight" style="width:80%">
<h1>Abrir ou Alterar Empresa</h1>
  <h2>Alterar Sociedade Empresária Limitada</h2>
