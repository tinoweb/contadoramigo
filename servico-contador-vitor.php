...
//	error_reporting(E_ALL);
	...
	if (isset($_SESSION["id_userSecao"])) 
	{
		...
		require_once('Controller/servicos_assinatura_contador-controller.php');

		$LinhasGrid = new ServicosAssinaturaContador();
	
		$tabelaServicoAvulso = $LinhasGrid->itensTabela($_SESSION['id_userSecaoMultiplo']);
		...
		// Realiza a requisição da chamada do controle.
		require_once('Controller/contratar_servicos-controller.php');

		$servicosObject = new ContrataServicos();
		
		$tabelaServicoAvulso = $servicosObject->GetTableServicos(); 
	}
...
<label>
    <input type="radio" name="RadioGroup1" value="opção" id="RadioGroup1_0">
...
<label>
    <input type="radio" name="RadioGroup2" value="opção" id="RadioGroup1_0">
    R$ 200 por trabalhador admitido/demitido.</label>
  <br><br>
...
<br><br>
<center><input type="submit" class="botao" value="Solicitar orçamento"></center>
	</div>
</div>
<!--fim box12 -->																													
