...
<h2 class="tituloVermelho" style="margin-bottom:20px">Abra sua empresa de graça. Siga nosso tutorial e faça sozinho a abertura de sua empresa.</h2>

Inicialmente vale ressaltar que este tutorial é voltado  para o registro de empresas<b> sediadas no Estado de São Paulo</b>. <br><br>

<b>Empresas de outros estados</b> também podem utilizar este tutorial, mas não terão um passo-a-passo para registro na Junta em seu Estado (Estamos ainda trabalhando nesse sentido). <br><br>

<b>Escritórios de Advocacia</b> devem observar que a OAB não permite a abertura de sociedades empresariais na Junta Comercial. Assim, não será possível  seguir esta parte do tutorial. A nova empresa deverá ser registrada na própria OAB, como Sociedade Simples ou Sociedade Unipessoal.<br><br>

Bem, isto posto, vamos lá! Antes de iniciar o processo de abertura propriamente dita, é preciso definir algumas questões:<br><br>
...
Como as alíquotas variam de acordo com a atividade, procure encaixar códigos que pagam menos impostos. Além disso, é preciso verificar se a atividade  é permitida ao Simples. Acesse nossa <a href="https://www.contadoramigo.com.br/abertura_selecao_atividades.php">Página de Seleção de Atividades</a>, para fazer estas verificações.<br><br>
Definidas estas questões, você está pronto para iniciar a abertura de sua empresa.<br><br>

<h2 class="tituloVermelho">Registrando sua Microempresa ou EPP</h2>
	O primeiro passo para o registro de sua empresa é dar entrada com o processo na Junta Comercial. Cada estado tem normas e regulamentos próprio, mas quase todos já dispõem de mecanismos online para geração dos formulários, documentos e guias de impostos necessários. Se você é do Estado de São Paulo, siga nosso <a href="abertura_junta_sp_geral.php">tutorial de registro na Junta</a>. <br><br>
...
Leve toda essa papelada até a Junta Comercial. A documentação será analisada e, se estiver  em ordem, a alteração será homologada. Se houver alguma irregularidade, o processo retorna, para que você o complemente com a exigência solicitada.<br /><br />

Depois de homologado, sua empresa já estará aberta perante o Estado e a Receita Federal. Ficará ainda faltando efetuar o cadastro junto à Prefeitura. A maioria das cidades já possibilitam o preenchimento online. Verifique se esta facilidade  já está disponível na sua cidade. Em São Paulo - SP, acesse nosso <a href="abertura_ccm.php">tutorial de Inscrição Municipal</a>.<br /><br />

Depois disso sua empresa estará aberta, mas antes de comemorar <a href="https://www.contadoramigo.com.br/enquadramento_simples.php">solicite sua adesão ao Simples Nacional</a>, para que você já comece a gozar dos benefícios fiscais. <b>Empresas recém-abertas têm até 30 dias para fazê-lo, </b>a contar do último deferimento de inscrição (municipal ou estadual). Se não o fizer, você será automaticamente enquadrado no Regime de Lucro Presumido e só poderá solicitar seu enquadramento no Simples em janeiro do ano seguinte.<br><br>

Uma vez deferido seu enquadramento no Simples, pode abrir a champanhe. Sua nova empresa estará pronta para começar!<br><br><br>

<h2 class="tituloVermelho">Cadastro na Nota Fiscal Eletrônica</h2>
