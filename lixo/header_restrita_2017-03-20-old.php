...
if(($_SESSION['status_userSecao']=='inativo') or ($_SESSION['status_userSecao']=='demoInativo') or ($_SESSION['status_userSecao']=='cancelado')) {
	if(  (substr($_SERVER['REQUEST_URI'],0,17) == '/gerar-boleto.php') or (substr($_SERVER['REQUEST_URI'],0,19) == '/boleto_vencido.php') or (substr($_SERVER['REQUEST_URI'],0,24) == '/minha_conta_cancela.php') or (substr($_SERVER['REQUEST_URI'],0,20) == '/boleto_promocao.php') or (substr($_SERVER['REQUEST_URI'],0,22) == '/promo_certificado.php') or (substr($_SERVER['REQUEST_URI'],0,16) == '/minha_conta.php') or (substr($_SERVER['REQUEST_URI'],0,21) == '/minha_conta.php') or (substr($_SERVER['REQUEST_URI'],0,24) == '/minha_conta_cancela.php') or (substr($_SERVER['REQUEST_URI'],0,12) == '/suporte.php') or (substr($_SERVER['REQUEST_URI'],0,8) == '/suporte') or (substr($_SERVER['REQUEST_URI'],0,23) == '/suporte_visualizar.php')) { 
...
<?php 
	...
	if( !isset( $objeto_contrato['aceito'] ) ):
		...
		if( $page_atual != "/boleto_promocao.php?promocao_demos_inativos" && $page_atual != "/promo_certificado.php" && $page_atual != "/suporte.php" && $page_atual != "/minha_conta.php" && $page_atual != "/minha_conta.php?erro_cartao=invalido" && $page_atual != "/minha_conta.php?sucesso"  && substr($page_atual,0,23) != "/suporte_visualizar.php" ):
			
			if(  $page_atual != "/boleto_certificado.php" && $page_atual != "/minha_conta_cancela.php" ){
...
<a href="https://www.youtube.com/c/ContadoramigoBrasil" target="_blank" style="color:#003d62"><i class="fa fa-youtube-square"></i></a>
...
<!--  <li>|</li>-->
	<li class="hasChild"><a class="linkMenu" href="#">Pagamentos</a>
	  <div class="linha-branca-menu"></div>
	  <ul style="width: 140px !important;">
...
<!--  <li>|</li>-->
		<li class="hasChild"><a class="linkMenu" href="#">CheckUp Fiscal</a>
		  <div class="linha-branca-menu"></div>
		  <ul style="width: 200px !important;">
		    <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="situacao_fiscal.php">Consulta da situação fiscal</a></li>
		    <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="checkup.php">Certidões negativas de débitos</a></li>
		  </ul>
	  </li>
<!--  <li>|</li>-->
	<li class="hasChild"><a class="linkMenu" href="#">Livro Caixa</a>
	  ...
	  <ul style="width:140px  !important;">
	    ...
	    <!-- <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="balanco-patrimonial.php">Balanço Patrimonial</a></li> -->
	    <!-- <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="dre.php">DRE</a></li> -->
	    <!-- <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="#">Livro Diário</a></li> -->
	    <!-- <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="#">Livro Razão</a></li> -->
	    <!-- <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="#">Configuração</a></li> -->
	  </ul>
  </li>
...
<!--  <li>|</li>-->
	<li class="hasChild"><a class="linkMenu" href="#">Abrir ou Alterar Empresa</a>
	  <div class="linha-branca-menu"></div>
	  <ul style="width: 260px !important;">
      <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="abertura_empresa.php">Abrir uma nova empresa (qualquer tipo)</a></li>
	    <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="alteracao_contrato_sociedade_junta.php">Alterar uma Sociedade Empresária</a></li>
	    <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="alteracao_contrato_individual.php">Alterar Empresário individual ou EIRELI</a></li>
        <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="alteracao_contrato_sociedade_cartorio.php">Alterar Sociedades registradas em cartório</a></li>
        <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="desenq_mei.php">Transformar MEI em ME</a></li>
	  </ul>
  </li>
<!--  <li>|</li>-->
	<li class="hasChild"><a class="linkMenu" href="#">Outros Serviços</a>
	  <div class="linha-branca-menu"></div>
	  <ul style="width: 230px !important;">
	    ...
	    <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="abertura_selecao_atividades.php">Seleção de Atividades (CNAE)</a></li>
        <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="emprestimos.php">Empréstimos Sócio x Empresa</a></li>
        <?php if( $_SESSION['id_userSecao'] == 9 || $_SESSION['id_userSecao'] == 1581 ){ ?>

        <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="servicos_assinatura_contador.php">Serviços com Assinatura do Contador</a></li>
