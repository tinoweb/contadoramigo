		...
		<form id="formGerarReciboEmprestimo" action="recibo_emprestimo.php" method="post">
			...
			<table width="900" cellpadding="3" style="margin-bottom:10px;">			
				<tbody style="float:left">
					...
					<tr>
						...
						<td align="left" valign="top" class="formTabela">
							<input name="devolucao_emprestimo" id="devolucao_emprestimo" class="campoData" type="text" size="10" disabled="disabled">
						</td>
					</tr>
					...
					<tr>
						...
						<td align="left" valign="top" class="formTabela">
							<input name="juros_emprestimo" id="juros_emprestimo" type="text" value="" size="8"> 
							% (<span style="margin-bottom:20px">Você poderá alterar para mais, desde que não ultrapasse a Selic ( <?php echo $taxa_selic; ?> ) ou para menos.</span></td>
					</tr>
					<tr>
						<td><br></td>
						<td><br></td>
			...
			<div style="margin-bottom:20px;margin-top:30px;position: relative;">
				...
				<div style="display:none;margin-bottom: 5px;width:100%;float:left;margin-top: 15px;" class="valor_total_repassar">
					Valor liquído a emprestar (descontado o IOF): R$ <span id="valor_total_repassar" class="destaque">XX,XX</span>
				</div>
		...
		<table id="tabela_itens" width="960" cellpadding="5">
          	<tbody>
				<tr>
					...
					<th width="9%">IOF</th>
					<th width="9%">IRRF</th>
					<th width="9%" colspan="2">Gerar Darf</th>
