...
//	error_reporting(E_ALL);	
	...
	if($_GET) {
		...
		// Imprime o iframe.
		echo '<iframe src="boleto.class.alteracao.php?id_historico='.$id_historico.'&tipo='.$tipo.'&id_user='.$id_user.'&tipo_plano='.$tipo_plano.'&via='.$via.'&contadorId='.$contadorId.'" style="width: 666px;border: 0;height: 1000px;"></iframe>';
	}
	include 'rodape.php';
?>
