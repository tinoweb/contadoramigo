...
<div class="principal">
<h1 style="font-size:1em">Assinatura</h1>
<h2>Acesso grátis por 30 dias, sem compromisso!</h2>
<div style="margin-bottom:20px">A assinatura gratuita dá acesso integral a todas as funcionalidades. Esgotado o período de avaliação, se não quiser continuar, basta abandonar o serviço, sem necessidade de comunicação prévia.</div>
  <form name="frmAssinatura" id="frmAssinatura" method="post" action="assinatura_gravar.php">
    <input type="hidden" name="hidPass" id="hidPass" value="1">
    <div style="float:left; width:15%" >Nome:</div><div style="float:left; width:85%"><input name="txtAssinante" type="text" id="txtAssinante" style="border:1px solid #cccccc;margin-top:2px;width:97%; margin-bottom:0px" maxlength="200"  alt="Nome"  /></div>
<div style="clear:both; height:10px"></div>

<div style="float:left; width:15%" >E-mail:</div><div style="float:left; width:85%"><input type="text" name="txtEmailAssina" id="txtEmailAssina" style="border:1px solid #cccccc;margin-top:2px;width:97%" maxlength="200" alt="E-mail" /></div>
<div style="clear:both; height:10px"></div>

    <div style="float:left; width:15%" >Fone:</div>
    <div style="float:left; width:20%">
        <input name="txtPrefixoTelefoneCobranca" type="text" id="txtPrefixoTelefoneCobranca" style="border:1px solid #cccccc;margin-top:2px;width:80%" maxlength="2" alt="Prefixo do Telefone para Cobrança" /></div><div style="float:left; width:65%"><input name="txtTelefoneCobranca" type="text" id="txtTelefoneCobranca" style="border:1px solid #cccccc;margin-top:2px;width:96%" maxlength="9" alt="Telefone para Cobrança" />
    </div>
    <div style="clear:both; height:20px"></div>

    <div style="float:left;width:140px" >Defina uma Senha:</div>
    <div style="float:left;">
        <input type="password" size="20" name="txtSenhaAssina" id="txtSenhaAssina" style="border:1px solid #cccccc;margin-top:2px;width:80px" maxlength="10" alt="Senha" />
        <span style="font-size:0.8em"> (8 a  10 caracteres)</span>
    </div>
    <div style="clear:both; height:10px"></div>
    ...
    <div style="float:left;">
        <input type="password" size="20" name="txtConfirmaSenhaAssina" id="txtConfirmaSenhaAssina" style="border:1px solid #cccccc;margin-top:2px;width:80px" maxlength="10" alt="Confirmação de Senha" />
    </div>
    <div style="clear:both; height:20px"></div>
...
<div style="width:100%; margin-bottom:20px"><input type="checkbox" name="cheTermos" id="cheTermos" /> Li  e concordo com os <a href="javascript:abreDiv('contrato')">termos e condições</a>.</div>

    <div class="bubble_right_top" style="width:60%; float:left; margin-right:20px">
        <div style="padding:15px">
            <h3>Nesta primeira fase atendemos apenas:</h3>
      ...
      <img src="images/boneca-assinatura.png" alt="Faça você mesmo a contabilidade online de sua empresa." title="Faça você mesmo a contabilidade online de sua empresa." style="float:left; width:30%; margin-top:10px"/> 
        <div style="width:100%; text-align:center; clear:both; margin-bottom:20px"><input type="button" value="Prosseguir" id="btProsseguir" /></div>
...
<!--CONTRATO -->
<div id="contrato" style="width:100%; background:#FFF; position:absolute; left:0px; top:0px; display:none; z-index: 999;">
<div style="padding:20px">

<div style="float:right"><a href="javascript:fechaDiv('contrato')"><img src="images/x.png" width="8" height="9" border="0" alt="fechar contrato" title="fechar contrato" /></a></div>
...
boa fé. </p>
<p style="text-align:center"><input type="button" value="Fechar" onClick="javascript:fechaDiv('contrato')"></p>
</div>
</div>
</div>
<!--FIM DO CONTRATO -->
