...
//		
	...
	class Boleto{
		...
		function gerarNossoNumero(){
			...
			else if( $this->gettipo_boleto() == "F_firma_individual" )
			{ 
				return $this->getGerarNossoNumeroBoleto(); // Gera o nosso numero.
			}
			else if( $this->gettipo_boleto() == "F_sociedade_empresária" )
			{ 
				return $this->getGerarNossoNumeroBoleto(); // Gera o nosso numero.
			}
		}
	...
	else if( $_GET['tipo'] == "Gfip_GPS" ){
		//Define o tipo de boleto avulso
		$boleto->DefinePadraoBoletoAvulso($_GET['tipo']);
	}
	else if( $_GET['tipo'] == "Simples_DAS" ){
		//Define o tipo de boleto avulso
		$boleto->DefinePadraoBoletoAvulso($_GET['tipo']);
	}
	else if( $_GET['tipo'] == "Defis" ){
		//Define o tipo de boleto avulso
		$boleto->DefinePadraoBoletoAvulso($_GET['tipo']);
	}
	else if( $_GET['tipo'] == "Rais_negativa" ){
		//Define o tipo de boleto avulso
		$boleto->DefinePadraoBoletoAvulso($_GET['tipo']);
	}
	else if( $_GET['tipo'] == "Dirf" ){
		//Define o tipo de boleto avulso
		$boleto->DefinePadraoBoletoAvulso($_GET['tipo']);
	}
	else if( $_GET['tipo'] == "F_firma_individual" ){
		//Define o tipo de boleto avulso
		$boleto->DefinePadraoBoletoAvulso($_GET['tipo']);
	}
	else if( $_GET['tipo'] == "F_sociedade_empresária" ){
		//Define o tipo de boleto avulso
		$boleto->DefinePadraoBoletoAvulso($_GET['tipo']);
	}
?>