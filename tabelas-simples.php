...
<div class="principal">
  <h1>Tabelas do Simples</h1>
	<h2>Escolha a alíquota mais conveniente para sua atividade.</h2>
...
<div style="float: left; margin-bottom: 20px">   
 	<form method="post" action="tabelas-simples.php">
