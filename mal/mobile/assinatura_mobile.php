...
<div style="float:left; width:15%" >Nome:</div><div style="float:left; width:85%"><input name="txtAssinante" type="text" id="txtAssinante" style="width:100%; margin-bottom:0px" maxlength="200"  alt="Nome"  /></div>
<div style="clear:both; height:10px"></div>

<div style="float:left; width:15%" >E-mail:</div><div style="float:left; width:85%"><input type="text" name="txtEmailAssina" id="txtEmailAssina" style="width:100%" maxlength="200" alt="E-mail" /></div>
<div style="clear:both; height:10px"></div>

<div style="float:left; width:15%" >Fone:</div><div style="float:left; width:20%"><input name="txtPrefixoTelefoneCobranca" type="text" id="txtPrefixoTelefoneCobranca" style="width:95%" maxlength="2" alt="Prefixo do Telefone para Cobrança" /></div><div style="float:left; width:65%"><input name="txtTelefoneCobranca" type="text" id="txtTelefoneCobranca" style="width:100%" maxlength="9" alt="Telefone para Cobrança" /></div>
<div style="clear:both; height:20px"></div>

<div style="float:left; width:40%" >Defina uma Senha:</div><div style="float:left; width:60%"><input type="password" name="txtSenhaAssina" id="txtSenhaAssina" style="width:80px" maxlength="10" alt="Senha" /><span style="font-size:0.8em"> (8 a  10 caracteres)</span></div>
<div style="clear:both; height:10px"></div>

<div style="float:left; width:40%" >Confirme a Senha:</div><div style="float:left; width:60%"><input type="password" name="txtConfirmaSenhaAssina" id="txtConfirmaSenhaAssina" style="width:80px" maxlength="10" alt="Confirmação de Senha" /></div>
<div style="clear:both; height:20px"></div>
