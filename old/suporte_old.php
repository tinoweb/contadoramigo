...
<div style="margin-bottom:15px"><strong>Exclusivamente para assuntos relacionados à cobrança</strong>, você poderá também entrar em contato com o<strong> Contador Amigo</strong> pelo tel: (<strong>11) 3434-6631</strong>, no horário das 9 às 18 horas, de segunda a sexta.</div>

<div class="tituloVermelho" style="margin-bottom:5px">Suporte Remoto</div>
<div style="margin-bottom:20px">Se você estiver com dificuldades técnicas e não for possível resolvê-las com a simples troca de mensagens, nossa equipe de suporte poderá acessar sua tela e orientá-lo na solução dos problemas. Solicite aqui no Help Desk uma sessão remota.<br />
<br />
O acesso se dará através do <strong>Skype</strong>. Na data e horário combinado, adicione <strong>contadoramigo</strong> à sua lista de contatos e inicie um chat. Você será orientado pelo nosso operador sobre como compartilhar a sua tela.</div>
...
<div class="bubble_right_bottom box_visualizacao x_visualizacao check_visualizacao" style="padding:0; width:350px; position:absolute; top:350px; left:50%; margin-left: -345px;" id="erro_anexo_suporte">
...
<!--FIM DO BALLOOM erro_anexo_suporte -->
 ...
 <div style="float:left">
  ...
  <tr>
    ...
    ?>
    <td class="formTabela"><input type="text" name="txtNome" id="txtNome" value="<?=$objeto["assinante"]?>" style="width:400px" >
</td>
  </tr>
  <tr>
