  ...
  ?>
    ...
    <tr>
      ...
      <td class="formTabela"><select name="selInscritaComo" id="selInscritaComo" onchange="selecionaRegistro()" style="float:left">
        ...
        <option value="Empresa Individual de Responsabilidade Limitada (EIRELI)" <?php echo selected( 'Empresa Individual de Responsabilidade Limitada (EIRELI)', $inscrita_como ); ?>  onchange="selecionaRegistro()" >Empresa Individual de Responsabilidade Limitada (EIRELI)</option>
...
<br />
  ...
  ?>
  	<div style="text-align: left; margin-bottom:10px; width:75%"><a href="meus_dados_empresa.php?act=new">Cadastrar nova Empresa</a></div>
	<?	
  }
...
<div style="text-align: right; margin-bottom:10px; width:99.8%"><a href="meus_dados_empresa.php?act=new">Cadastrar <?=$_SESSION['n_empresasVinculadas'] > 0 ? 'outra' : ''?> empresa</a></div>
