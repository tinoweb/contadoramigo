 ...
 *
 * *admin/cad_atualiza_livro_caixa.php
 *		inclua na variável da linha 69 o resultado da ação do serviço.
 *		ex: $resultadoAcaoSerico = "'8.2',...,'11.4'";
 */
...
<div id="box14" class="box_servico_contador">
	<form method="get" action="<?php echo $action;?>">
		...
		<input type='hidden' name='id_user' value='<?php echo $userId; ?>' />
		<input type='hidden' name='data' value='<?php echo $data; ?>' />	
		<input type='hidden' name='tipo' value='DeSTDA' />
		<div style="padding: 10px">
			<h3>DeSTDA</h3>
...
<div id="box15" class="box_servico_contador" style='min-height:278px;'>
	<div style="padding: 10px">
		...
		<br><br>
		<center>
			<input type="button"  value="Solicitar orçamento" onClick="location.href='/irpf.php'" style="margin-bottom: 5px">
		</center>
	</div>
</div>
<!--fim box15 -->
