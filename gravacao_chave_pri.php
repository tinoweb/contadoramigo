...
<br />
<br /> 
Abra novamente o programa Cliente de 
Certificação e clique em <strong>Receber</strong>.<br />
<br />
<img src="images/cliente_certificacao/14.png" width="55%" height="40%" style="border-width:1px; border-color:#CCC; border-style:solid" />
</div>
...
<br />
<br /> 
Conecte o <em>pendrive</em> com a chave que você homologou na agência da Caixa e em seguida clique <strong>OK</strong>.<br /><br />
<img src="images/cliente_certificacao/15.png" width="55%" height="40%" /><br />
</div>
...
<br /> 
<br />
Na janela que se abrirá, selecione o arquivo gravado no <em>pendrive</em> e clique em <strong>Abrir</strong>.<br /><br />
<img src="images/cliente_certificacao/16.png" width="55%" height="40%" /><br />
</div>
...
<br />
<br /> 
Informe a senha que você criou ao gerar  a chave (antes de levá-la à Caixa) e clique <strong>Ok</strong> .<br /><br />
<img src="images/cliente_certificacao/17.png" width="55%" height="40%" /><br />
</div>
...
<br />
<br /> 
Se tudo correr bem, aparecerá a mensagem abaixo e o ícone da Chave PRI mudará, representendo que foi certificada.<br /><br />
<img src="images/cliente_certificacao/18.png" width="55%" height="40%" /><br />
</div>
...
<br />
<br /> 
Agora você deverá  copiar a <strong>Chave PRI certificada</strong> para um  <em>pendrive</em>, a fim de usá-la posteriormente na transmissão da Gfip. Pode ser o mesmo<em> </em>que você estava usando, mas, cuidado, os arquivos que lá estiverem serão todos apagados. Em tese você não precisaria mais deles mesmo, mas nunca se sabe. Então, por segurança, copie  os arquivos que estavam no <em>pendrive</em> para um outro local  antes gravar  a Chave PRI. Feito isto,  simplesmente clique no ícone da Chave PRI e depois em<strong> Criar Disquete</strong>.<br /><br />
<img src="images/cliente_certificacao/19.png" width="55%" height="40%" /><br />
</div>
...
<br />
<br /> 
Certifique-se de que o <em>pendrive</em> está conectado ao micro e clique <strong>Ok</strong> para prosseguir.<br /><br />
<img src="images/cliente_certificacao/20.png" width="55%" height="40%" /><br />
</div>
...
<br />
<br /> 
Conforme alertamos no passo 6, uma mensagem o avisará de que todos os dados existentes no disquete (isto é, no <em>pendrive</em>) serão revovidos. Clique <strong>Ok</strong> para prosseguir.<br /><br />
<img src="images/cliente_certificacao/21.png" width="55%" height="40%" /><br />
</div>
...
<br />
<br />
Uma nova janela se abrirá. Clique em <strong>Salvar</strong>.<br /><br />
<img src="images/cliente_certificacao/22.png" width="55%" height="40%" /><br />
</div>
...
<br />
<br /> 
Será requerida a mudança da senha. Informe primeiro a  anterior e depois  a nova. Se quiser, pode manter a mesma. Clique <strong>Ok</strong> e Pronto! A Chave PRI certificada foi gravada no seu <em>pendrive</em>. Não aparece nenhum aviso de sucesso (o que, depois de tanto trabalho, é um pouco decepcionante). Confirme se o arquivo está no <em>pendrive</em>. Sua chave estará pronta para uso.<br /><br />
<img src="images/cliente_certificacao/23.png" width="55%" height="40%" /><br />
</div>
