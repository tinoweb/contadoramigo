...
<br />
<br /> 
Nesta tela você informará detalhes importantes sobre sua apuração que irão definir o valor de sua alíquota. Muita atenção no preenchimento. Baseado em seus dados cadastrais e nas respostas fornecidas anteriormente, o Contador Amigo identificou o(s) item(s) que você deve selecionar. São eles:<br><br>
...
<br />
<br /> 
No campo <strong>Receita</strong> do quadro <em><strong>Sujeitos ao fator "R" sem retenção/substituição tributária de ISS, com ISS devido ao próprio município do estabelecimento</strong></em> informe a soma das notas fiscais emitidas por você referente a(s) atividade(s):
	<ul>
	<li>Portais, provedores de conteúdo e outros serviços de informação na internet</li>
	<li>ividades de intermediação e agenciamento de serviços e negócios em geral, exceto imobiliários</li>
	</ul>
<br>
No campo <strong>Receita</strong> do quadro <em><strong>Não sujeito ao fator "R" tributados pelo Anexo III sem retenção/substituição tributária de ISS, com ISS devido ao próprio município do estabelecimento</strong></em> informe a soma das notas fiscais emitidas por você referente a(s) atividade(s):
	<ul>
	<li>Portais, provedores de conteúdo e outros serviços de informação na internet</li>
	<li>Aividades de intermediação e agenciamento de serviços e negócios em geral, exceto imobiliários</li>
	</ul>
<br>
Não preencha ou selecione nada nos campos COFINS, CSLL, INSS/CPP, IRPJ etc.
<br>
<br>
...
<br />
<br /> 
Preencha os valores desembolsados com salários, pagamento a autônomos e pró-labore, para cada um dos meses solicitados (valores brutos, incluindo encargos e o 13º salário).<br><br>
