...
<h1>Abrir ou Alterar Empresa</h1>
  ...
  <h2>Alteração de Firma Individual ou Eireli</h2>
    Como <strong>Empresa individual</strong>, você não possui um contrato social, mas  um registro na Junta Comercial. Para alterar seus dados, deverá ir até a Junta  de sua cidade e solicitar o kit de alteração contratual, que inclui:
    

<ul>
  <li> Formulário de requerimento <br />
  <li> Guias para recolhimento das taxas Federal (DARF) e Estadual (DARE) <br />
  <li> Lista dos documentos necessários (esta relação varia de acordo com o tipo de alteração solicitada)<br />
</ul>
