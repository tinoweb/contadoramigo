...
<h2>Pessoas Jurídicas</h2>
 ...
 Antes de fazer um pagamento a qualquer pessoa jurídica que lhe prestou serviços, você precisa saber se  a mesma está sujeita a retenção de IR, ISS ou INSS. Embora o imposto seja devido pela empresa que lhe prestou o serviço, você é quem fica o responsável pelo pagamento. Nesta página você poderá cadastrar os serviços tomados, verificar se há alguma retenção, qual o valor e será orientado sobre como pagá-la.<br />
  <br />
  Não deixe de cadastrar os pagamentos, especialmente aqueles sujeitos a retenção. Você precisará saber os valores retidos para enviar no início do ano a Declaração de Imposto de Renda Retido na Fonte (DIRF) e o Comprovante de Rendimentos Pagos e de Retenção na Fonte. Não se desespere, o Contador Amigo vai ajudá-lo nisso também!<br /><br>
  
  <strong>Não use esta página para cadastrar compras</strong>. As aquisições de bens e produtos podem ser cadastradas diretamente no livro-caixa, pois não sofrem retenção.<br>
<br><br>
...
<h2>Cálculo de retenção e pagamento líquido</h2>
...
<!--nome -->
<div style="float:left; margin-right: 10px"><label for="NomeEmpresa">Nome da empresa: </label></div>
<div style="float:left;"><select name="NomeEmpresa" id="NomeEmpresa">
	<option value="">Selecione a empresa a ser paga</option>
<?
...
<div id="linha_tipo_servico" style="display:none;">
	<div style="margin-bottom: 20px">Você cadastrou esta empresa em <a href="https://www.contadoramigo.com.br/meus_dados_pj.php">Fornecedores</a> como NÃO OPTANTE pelo Simples. Neste caso, ela poderá sofrer retenção de IR. Verifique na lista abaixo se a empresa exerceu alguma das atividades sujeitas a retenção. Se não estiver na lista é porque não tem retenção. Neste caso selecione OUTROS SERVIÇOS NÃO LISTADOS ACIMA.</div>

<div style="float:left; margin-right: 10px">Tipo de serviço: </div>
...
<div style="margin-bottom: 20px">Esta empresa consta como sediada a um município diferente do seu. Neste caso, ela poderá sofrer retenção de ISS. Verifique na lista abaixo se a empresa exerceu alguma das atividades sujeitas a retenção. Se não estiver na lista é porque não tem retenção. </div>

	<div style="clear:both; height:10px"></div>
    <div style="margin-bottom:15px">O serviço prestado está entre as atividades listadas a seguir?</div>
    
    <div style="float:left; margin-right:20px">
        <li>Instalação dos andaimes, palcos e coberturas</li>
...
<div style="margin-bottom: 20px">Esta empresa consta como sediada a um município diferente do seu. Neste caso, ela poderá sofrer retenção de ISS. Verifique na lista abaixo se a empresa exerceu alguma das atividades sujeitas a retenção. Se não estiver na lista é porque não tem retenção. </div>
    ...
    <div style="float:left; margin-right:20px">
        <li>Cessão de andaimes, palcos e coberturas e outras estruturas de uso temporário.</li>
...
<div id="linha_orientacoes" style="display:none;">
	<h2 style="width: 80%">Orientações</h2>
    <div style="width:80%"> 
