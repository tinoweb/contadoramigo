...
<div class="principal" style="display:block">
	...
	<div class="quadro_passos" style="text-align: center" width="100%">
		<div class="perguntas_simples" style="text-align: left;">
			<span style="display: inline-block; width: 500px">Houve faturamento em sua empresa no período?</span>
			...
			<br>
			<br>			
			<span style="display: inline-block; width: 500px">O período de apuração é o de 2018?</span>
			<div style="display: inline-block; margin-left: 10px;">
...
<script>
	...
	jQuery(document).ready(function($){
		...
		$('#status_faturamento_nao').click(function(){
			...
			$('#status_faturamento_sim').css("background-color", "#024a68");
		...
		$('#bt_continuar').click(function(){
			...
			if(validacao()){
				...
				else if(status_faturamento == 'nao' && status_2018 == 'sim') {
					window.location.assign("simples_orientacoes_2_sem_movimento.php")
				} 
