...
if(isset($_GET['acao']) && $_GET['acao'] != ''){
	...
	$check = mysql_query("SELECT * FROM dados_da_empresa_codigos WHERE id='" . $_SESSION["id_userSecao"] . "' AND REPLACE(REPLACE(REPLACE(cnae,'.',''),'-',''),'/','')='$codigo' AND REPLACE(REPLACE(REPLACE(cnae,'.',''),'-',''),'/','') <> '$campoCheck' ");
