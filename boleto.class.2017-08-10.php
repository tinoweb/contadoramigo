...
//	error_reporting(E_ALL);
	...
	class Boleto{
		...
		function getTiposServico() {
			return array('A_empresa','A_sociedade','decore','DBE','Gfip_GPS','Simples_DAS','Defis','Rais_negativa','Dirf','F_empresa','F_sociedade','MEI-ME','CPOM');
		}
		function getTiposBoleto() {
			return array('A_empresa','A_sociedade','decore','DBE','Gfip_GPS','Simples_DAS','Defis','Rais_negativa','Dirf','F_empresa','F_sociedade','MEI-ME','CPOM', 'ComplementarPremium');
		}
		function getvia(){
			return $this->via;
		}
		...
		function gerarNossoNumero(){
			...
			else if( $this->gettipo_boleto() == "A_empresa" )
			{ 
				return $this->getGerarNossoNumeroBoleto(); // Gera o nosso numero.
			}
			else if( $this->gettipo_boleto() == "A_sociedade" )
			{
				return $this->getGerarNossoNumeroBoleto(); // Gera o nosso numero.
			}						
			...
			else if( $this->gettipo_boleto() == "Gfip_GPS" )
			{ 
				return $this->getGerarNossoNumeroBoleto(); // Gera o nosso numero.
			}
			else if( $this->gettipo_boleto() == "Simples_DAS" )
			{ 
				return $this->getGerarNossoNumeroBoleto(); // Gera o nosso numero.
			}
			else if( $this->gettipo_boleto() == "Defis" )
			{ 
				return $this->getGerarNossoNumeroBoleto(); // Gera o nosso numero.
			}
			else if( $this->gettipo_boleto() == "Rais_negativa" )
			{ 
				return $this->getGerarNossoNumeroBoleto(); // Gera o nosso numero.
			}
			else if( $this->gettipo_boleto() == "Dirf" )
			{ 
				return $this->getGerarNossoNumeroBoleto(); // Gera o nosso numero.
			}
			else if( $this->gettipo_boleto() == "F_empresa" )
			{ 
				return $this->getGerarNossoNumeroBoleto(); // Gera o nosso numero.
			}
			else if( $this->gettipo_boleto() == "F_sociedade" )
			{ 
				return $this->getGerarNossoNumeroBoleto(); // Gera o nosso numero.
			}
			else if( $this->gettipo_boleto() == "MEI-ME" )
			{ 
				return $this->getGerarNossoNumeroBoleto(); // Gera o nosso numero.
			}
			else if( $this->gettipo_boleto() == "CPOM" )
			{ 
				return $this->getGerarNossoNumeroBoleto(); // Gera o nosso numero.
			}
			else if( $this->gettipo_boleto() == "ComplementarPremium" )
			{ 
				return $this->getGerarNossoNumeroBoleto(); // Gera o nosso numero.
			}
		}
		...
		function verificaSegundaVia(){
			...
			if( isset($objeto['numdoc_get']) && $objeto['numdoc_get'] == $this->getnosso_numero() ){
				...
				elseif(isset($objeto['vencto_get']) && !empty($objeto['vencto_get']) && $objeto['vencto_get'] < date('Y-m-d')){
		...
		function DefinePadraoBoletoAvulso($tipo_boleto) {
	...
	if( $_GET['tipo'] == "mensalidade" ){
		...
		$boleto->DefinePadraoBoletoAvulso($_GET['tipo']);
	}
?>