<?php include 'meta_sem_certificado.php'; ?>
<?php include 'header.php' ?>

<div class="principal">

<div class="titulo" style="margin-bottom:10px;"><span class="titulo" style="margin-bottom:10px;">Simples Nacional e Gfip sem certificado digital</span></div>
<div style="margin-bottom:20px" class="tituloVermelho">Alteração da unidade do <em>pendrive</em> para <span class="tituloVermelho" style="margin-bottom:20px">&quot;</span>A&quot;</div>
...
<br />
<br />
Abra o menu <strong>Iniciar</strong> do Windows, clique com o botão direito do mouse em <strong>Computador</strong> e vá em <strong>Gerenciar</strong>.<br />
<br />
<img src="images/pendrive/1.png" width="564" height="736" />
</div>
...
<br />
<br /> 
Na janela que se abrirá, selecione <strong>Gerenciamento de Disco</strong>.<br /><br />
<img src="images/pendrive/2.png" width="757" height="385" /><br />
</div>
...
<br />
<br /> 
Encontre a letra  que representa seu <em>pendrive</em> e clique sobre ela com o botão direito do mouse. Nas opções que se abrirão, vá em <strong>Alterar letra de unidade e caminho</strong>.<br /><br />
<img src="images/pendrive/3.png" width="893" height="632" /><br />
</div>
...
<br />
<br />
Clique no botão <strong>Alterar</strong>.<br /><br />
<img src="images/pendrive/4.png" width="818" height="488" /><br />
</div>
...
<br />
<br /> 
Marque a opção <strong>Atribuir a seguinte letra de unidade </strong>e selecione a letra A na lista. Clique <strong>Ok</strong>. Pronto! A letra de seu <em>pendrive</em> foi alterada. Agora você conseguirá gravar a chave do Cliente de Certificação nele.<br /><br />
<img src="images/pendrive/5.png" width="891" height="523" /><br />
</div>
