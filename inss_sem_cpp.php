...
<ol>    
<li>A GPS, guia para recolhimento do INSS, <strong>só pode ser emitida após o <a href="gfip_orientacoes.php">envio da Gfip</a></strong> do mês. </li>
<!--<li>Empresas da construção civil deverão recolher em separado, além do INSS de sócios e funcionários, a <strong>CPP - Contribuição Previdenciária Patronal</strong>. <a href="inss_anexoIV.php">Veja como</a></li> -->
<li>Para cálculo de juros e multa de <strong>INSS em atraso</strong>, <a href="inss_atraso.php">clique aqui</a></li>
<li>Veja <a href="inss_compensacao.php">aqui</a> como <strong>compensar valores pagos indevidamente</strong> ou a maior<br />
</li>
<li>Se você enviou uma Gfip<strong> sem movimento</strong>, não tem nada a recolher ao INSS. </li>
...
Proceda da seguinte forma: abra novamente o programa Sefip. Vá ao menu superior e clique em<strong> Relatórios/Movimento/GPS.</strong><br />
    <br />
    <img src="images/sefip22.png" width="73%" height="55%" />
  </div>
...
Uma janela se abrirá, escolha a opção <strong>Gerar PDF</strong> e salve o arquivo em algum local fácil de encontrar. Sua GPS está pronta! Abra o PDF e imprima a guia.<br />
  ...
  <img src="images/sefip23.png" width="73%" height="55%" />
  </div>
...
Depois de pagar a GPS, junte todos os documentos e arquive-os. Missão cumprida!<br />
    <br />
    <img src="images/sefip22b.png" width="73%" height="55%" /><br />
    <br />
    <br />
