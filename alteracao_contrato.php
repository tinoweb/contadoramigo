...
//		alert(URL);
	...
	$('input[id^="txtCodigoCNAE"]').bind('change',function(){
		var 
			...
			, $idEmpresa = <?=$_SESSION["id_empresaSecao"]?>;			
		;
		if($campo.val() != ''){
 ...
 $('.btAdicionaCNAE').bind('click',function(e){
	 ...
	 //reposicionaBallons();
		...
		count = parseInt($('#countCNAEIncluso').val());

		
		orig.append('<div id="item'+count+'"><div style="float:left; margin-right:5px"><input name="txtCodigoCNAE'+count+'" id="txtCodigoCNAE'+count+'" type="text" style="width:75px; margin-top:3px;" class="campoCNAE" div="atividade'+count+'" check="hddCodigoCNAE'+count+'"><input type="hidden" name="hddCodigoCNAE'+count+'" id="hddCodigoCNAE'+count+'" value=""></div> <div id="atividade'+count+'" style="float:left; margin-top:5px"></div><div style="clear:both"></div></div>');
...
//			alert('1');
			var 
				...
				, $div		= $campo.attr("div")
				, $campoCheck		= $('#' + $campo.attr('check'))
				, $idEmp = <?=$_SESSION["id_empresaSecao"]?>;			
			;
...
//		return false;
	...
	if (document.getElementById('cheIncluirSocio').checked) {
		for (i=1;i<=(document.getElementById('count').value);i++) {//Retirei o -1 da frente do value
...
//	if(valor != ''){
		$.ajax({
			...
			data: 'nomeCookie='+objeto.name+'&valorCookie='+valor+'&id=<?=$_SESSION['id_empresaSecao']?>',
			async: false,
			type: 'POST'
		});		
//	}
...
<div class="principal">
	...
	<div class="minHeight" style="width:80%">
        <h1>Alteração do Contrato Social</h1>
          Esta página irá gerar  o documento de alteração do contrato social de sua empresa. Antes de iniciar, você deve completar todos os campos em <a href="meus_dados_empresa.php">Dados da Empresa</a> e incluir todos os sócios em <a href="meus_dados_socio.php">Cadastro de Sócios</a>, inclusive aqueles que eventualmente irão deixar a sociedade neste ato. Feito isto, preencha os campos abaixo. Uma nova janela se abrirá, com o documento pronto. Imprima-o em três vias.<br /><br />
...
<?php 
      ...
      $listaSocios = 1;
			...
			if((int)mysql_num_rows($resultado) > 0){
...
<input type="hidden" name="hidTotalSocioExistente" id="hidTotalSocioExistente" value="<?=mysql_num_rows($resultado)?>" />
    ...
    <input class="current" type="text" name="totalReaisAtual" id="totalReaisAtual" style="width:60px; margin-bottom:3px" maxlength="10" alt="capital social atual com o valor de cada quota (em reais)" value="<?=(getDadosContrato('dados_alteracao_contrato', 'totalReaisAtual', $_SESSION["id_empresaSecao"]))?>" /> Valor de cada quota (em reais)<br />
    
	<input class="inteiro" type="text" name="totalCotasAtual" id="totalCotasAtual" style="width:60px" alt="capital social atual com o total de cotas" value="<?=(getDadosContrato('dados_alteracao_contrato', 'totalCotasAtual', $_SESSION["id_empresaSecao"]))?>" /> Total de quotas<br />
    <br />
...
<? // 	CHECKBOX COM AS ALTERAÇÕES A SEREM FEITAS ?>
    <div class="destaqueAzul" style="margin-bottom:10px"> Quais as alterações a serem feitas?</div>
	    ...
	    <label><input type="checkbox" name="cheMudancaRazao" id="cheMudancaRazao" onClick="javascript:abreDiv('nova_razao'); " <?=(getDadosContrato('dados_alteracao_contrato', 'cheMudancaRazao', $_SESSION["id_empresaSecao"]) == 'on' ? 'checked' : '')?> /> Mudança da razão social</label><br />

<? // 	FORMULARIO DE MUDANÇA DE RAZAO SOCIAL ?>
        <div style="margin-left:17px; margin-bottom:20px; <?=(getDadosContrato('dados_alteracao_contrato', 'cheMudancaRazao', $_SESSION["id_empresaSecao"]) == 'on' ? 'display:block' : 'display:none')?>" id="nova_razao">

	        <div class="destaqueAzul" style="margin-bottom:5px; margin-top:10px">Nova razão social:</div>
            <input type="text" name="txtRazaoSocial" id="txtRazaoSocial" style="width:150px" alt="razão social" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtRazaoSocial', $_SESSION["id_empresaSecao"]))?>" />
        </div>




        <label><input type="checkbox" name="cheMudancaEndereco" id="cheMudancaEndereco" onClick="javascript:abreDiv('novo_endereco');" <?=(getDadosContrato('dados_alteracao_contrato', 'cheMudancaEndereco', $_SESSION["id_empresaSecao"]) == 'on' ? 'checked' : '')?> /> Mudança de endereço </label><br />

		<? // 	FORMULARIO DE MUDANÇA DE ENDEREÇO ?>
        <div style="margin-left:17px; <?=(getDadosContrato('dados_alteracao_contrato', 'cheMudancaEndereco', $_SESSION["id_empresaSecao"]) == 'on' ? 'display:block' : 'display:none')?>" id="novo_endereco">
            ...
            <div class="destaqueAzul" style="margin-bottom:5px; margin-top:10px">Novo endereço:</div>
                ...
                <table border="0" cellpadding="0" cellspacing="3" style="background:none" class="formTabela">
                    <tr>
                        ...
                        <td class="formTabela"><input name="txtEndereco" id="txtEndereco" type="text" style="width:300px" maxlength="200" alt="Endereço" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtEndereco', $_SESSION["id_empresaSecao"]))?>" /></td>
                    </tr>
                    <tr>
                        <td align="right" valign="middle" class="formTabela">Bairro:</td>
                        <td class="formTabela"><input name="txtBairro" id="txtBairro" type="text" style="width:300px" maxlength="200" alt="Bairro" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtBairro', $_SESSION["id_empresaSecao"]))?>" /></td>
                    </tr>
                    <tr>
                        <td align="right" valign="middle" class="formTabela">CEP:</td>
                        <td class="formTabela"><input name="txtCEP" id="txtCEP" type="text" style="width:70px" maxlength="9" alt="CEP" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtCEP', $_SESSION["id_empresaSecao"]))?>" /> <span style="font-size:10px">Ex.: 99999-999</span></td>
                    </tr>
                    <tr>
                        <td align="right" valign="middle" class="formTabela">Cidade:</td>
                        <td class="formTabela"><input name="txtCidade" id="txtCidade" type="text" style="width:300px" maxlength="200" alt="Cidade" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtCidade', $_SESSION["id_empresaSecao"]))?>" /></td>
                    </tr>
                    <tr>
                        <td align="right" valign="middle" class="formTabela">Estado:</td>
                        <td class="formTabela">
                        	<select name="selEstado" id="selEstado">
                                <option value="AC" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'AC' ? 'SELECTED' : '')?>>AC</option>
                                <option value="AL" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'AL' ? 'SELECTED' : '')?>>AL</option>
                                <option value="AM" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'AM' ? 'SELECTED' : '')?>>AM</option>
                                <option value="AP" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'AP' ? 'SELECTED' : '')?>>AP</option>
                                <option value="BA" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'BA' ? 'SELECTED' : '')?>>BA</option>
                                <option value="CE" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'CE' ? 'SELECTED' : '')?>>CE</option>
                                <option value="DF" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'DF' ? 'SELECTED' : '')?>>DF</option>
                                <option value="ES" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'ES' ? 'SELECTED' : '')?>>ES</option>
                                <option value="GO" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'GO' ? 'SELECTED' : '')?>>GO</option>
                                <option value="MA" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'MA' ? 'SELECTED' : '')?>>MA</option>
                                <option value="MG" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'MG' ? 'SELECTED' : '')?>>MG</option>
                                <option value="MS" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'MS' ? 'SELECTED' : '')?>>MS</option>
                                <option value="MT" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'MT' ? 'SELECTED' : '')?>>MT</option>
                                <option value="PA" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'PA' ? 'SELECTED' : '')?>>PA</option>
                                <option value="PB" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'PB' ? 'SELECTED' : '')?>>PB</option>
                                <option value="PE" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'PE' ? 'SELECTED' : '')?>>PE</option>
                                <option value="PI" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'PI' ? 'SELECTED' : '')?>>PI</option>
                                <option value="PR" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'PR' ? 'SELECTED' : '')?>>PR</option>
                                <option value="RJ" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'RJ' ? 'SELECTED' : '')?>>RJ</option>
                                <option value="RN" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'RN' ? 'SELECTED' : '')?>>RN</option>
                                <option value="RO" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'RO' ? 'SELECTED' : '')?>>RO</option>
                                <option value="RR" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'RR' ? 'SELECTED' : '')?>>RR</option>
                                <option value="RS" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'RS' ? 'SELECTED' : '')?>>RS</option>
                                <option value="SC" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'SC' ? 'SELECTED' : '')?>>SC</option>
                                <option value="SE" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'SE' ? 'SELECTED' : '')?>>SE</option>
                                <option value="SP" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'SP' || getDadosContrato('dados_alteracao_contrato', 'txtCidade', $_SESSION["id_empresaSecao"]) == '' ? 'SELECTED' : '')?>>SP</option>
                            	<option value="TO" <?=(getDadosContrato('dados_alteracao_contrato', 'selEstado', $_SESSION["id_empresaSecao"]) == 'TO' ? 'SELECTED' : '')?>>TO</option>
                    		</select>
						</td>
                    </tr>
                </table>
            ...
            <label><input type="checkbox" name="cheExcluirAtividade" id="cheExcluirAtividade" onClick="javascript:abreDiv('exclui_cnae'); " <?=(getDadosContrato('dados_alteracao_contrato', 'cheExcluirAtividade', $_SESSION["id_empresaSecao"]) == 'on' ? 'checked' : '')?> /> Exclusão de atividade</label><br />

			<? // 	FORMULARIO DE EXCLUIR ATIVIDADE ?>
            <div style="margin-left:17px; margin-top:10px; margin-bottom:20px; <?=(getDadosContrato('dados_alteracao_contrato', 'cheExcluirAtividade', $_SESSION["id_empresaSecao"]) == 'on' ? 'display:block' : 'display:none')?>" id="exclui_cnae">
                ...
                ?>
					<label><input type="checkbox" name="cheCnaeExcluso<?=$campo?>" id="cheCnaeExcluso<?=$campo?>" <?=(getDadosContrato('dados_alteracao_contrato', 'cheCnaeExcluso'.$campo, $_SESSION["id_empresaSecao"]) == 'on' ? 'checked' : '')?> /> <?=$linha2["denominacao"]?></label><br />
<?php 
						$campo = $campo + 1;
					}
?>
                ...
                <label><input type="checkbox" name="cheIncluirAtividade" id="cheIncluirAtividade" onClick="javascript:abreDiv('novo_cnae'); " <?=(getDadosContrato('dados_alteracao_contrato', 'cheIncluirAtividade', $_SESSION["id_empresaSecao"]) == 'on' ? 'checked' : '')?> /> Inclusão de atividade</label><br />


				<? // 	FORMULARIO DE INCLUIR ATIVIDADE ?>
                <div style="margin-left:17px; <?=(getDadosContrato('dados_alteracao_contrato', 'cheIncluirAtividade', $_SESSION["id_empresaSecao"]) == 'on' ? 'display:block' : 'display:none')?>" id="novo_cnae">
...
<?
										$novoCNAE = mysql_query("SELECT * FROM dados_alteracao_contrato WHERE nome_campo like 'txtCodigoCNAE%' AND id='" . $_SESSION["id_empresaSecao"] . "' ORDER BY nome_campo ASC")
										or die (mysql_error());
...
?>
                                            <div id="item<?=$totalCNAEs?>">
                                              <div style="float:left; margin-right:5px">
                                                <input name="txtCodigoCNAE<?=$totalCNAEs?>" id="txtCodigoCNAE<?=$totalCNAEs?>" type="text" style="width:75px;" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtCodigoCNAE'.$totalCNAEs, $_SESSION["id_empresaSecao"]))?>" maxlength="15" class="campoCNAE" div="atividade<?=$totalCNAEs?>" check="hddCodigoCNAE<?=$totalCNAEs?>" onBlur="<? // consultaBanco('meus_dados_empresa_consulta_cnae.php?codigo='+this.value, 'atividade<?=$totalCNAEs>');?>" alt="Código CNAE" /><input type="hidden" name="hddCodigoCNAE<?=$totalCNAEs?>" id="hddCodigoCNAE<?=$totalCNAEs?>" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtCodigoCNAE'.$totalCNAEs, $_SESSION["id_empresaSecao"]))?>">
                                              </div>
                                              <div id="atividade<?=$totalCNAEs?>" style="float:left; margin-top:5px"></div>      
...
?>
					...
					<label><input type="checkbox" name="cheExcluirSocio" id="cheExcluirSocio" onClick="javascript:abreDiv('exclui_socio');bloqueiaAletracaoCotas();reapareceSocioExcluido();" <?=(getDadosContrato('dados_alteracao_contrato', 'cheExcluirSocio', $_SESSION["id_empresaSecao"]) == 'on' ? 'checked' : '')?> /> Exclusão de sócio</label><br />

					<? // 	FORMULARIO DE EXCLUIR SOCIO ?>
                    <div style="margin-left:17px; margin-top:10px; margin-bottom:20px; <?=(getDadosContrato('dados_alteracao_contrato', 'cheExcluirSocio', $_SESSION["id_empresaSecao"]) == 'on' ? 'display:block' : 'display:none')?>" id="exclui_socio">
                        ...
                        while ($linha=mysql_fetch_array($resultado)) {
                        ?>
							<label><input type="checkbox" name="cheSocioExcluso<?=$campo?>" id="cheSocioExcluso<?=$campo?>" onClick="javaScript:someSocioExcluido(<?=$campo?>, this)" <?=(getDadosContrato('dados_alteracao_contrato', 'cheSocioExcluso'.$campo.'', $_SESSION["id_empresaSecao"]) == 'on' ? 'checked' : '')?>/> <?=$linha["nome"]?></label><br />
<?php 
							$campo = $campo + 1;
						}
?>
                    ...
                    <label><input type="checkbox" name="cheIncluirSocio" id="cheIncluirSocio" onClick="javascript:abreDiv('novo_socio');exibeNovosSocios();bloqueiaAletracaoCotas();" <?=(getDadosContrato('dados_alteracao_contrato', 'cheIncluirSocio', $_SESSION["id_empresaSecao"]) == 'on' ? 'checked' : '')?> /> Inclusão de novo sócio</label><br />

					<? // 	FORMULARIO DE MUDANÇA DE RAZAO SOCIAL ?>
                    <div style="margin-top:10px; margin-bottom:20px; <?=(getDadosContrato('dados_alteracao_contrato', 'cheIncluirSocio', $_SESSION["id_empresaSecao"]) == 'on' ? 'display:block' : 'display:none')?>" id="novo_socio">

                        <div id="form_socio">
                        
<?
							// CHECA SE HÁ ALGUM NOVO SÓCIO NA TABELA COM OS DADOS DO CONTRATO SALVO
							$novoSocio = mysql_query("SELECT * FROM dados_alteracao_contrato WHERE nome_campo like 'txtNome%' AND nome_campo not like 'txtNomeT%' AND id='" . $_SESSION["id_empresaSecao"] . "' ORDER BY nome_campo ASC")
							or die (mysql_error());
							...
							if(mysql_num_rows($novoSocio)>1){
								...
								while ($rsNovoSocio=mysql_fetch_array($novoSocio)) {
									$totalSOCIOs++;
									$ufSocio = getDadosContrato('dados_alteracao_contrato', 'selEstadoSocio'.$totalSOCIOs, $_SESSION["id_empresaSecao"]);
?>
                      ...
                      <table border="0" cellpadding="0" cellspacing="3" class="formTabela" style="background:none">
                          <tr>
                              ...
                              <td class="formTabela" width="300">
                                  <input name="txtNome<?=$totalSOCIOs?>" type="text" id="txtNome<?=$totalSOCIOs?>" style="width:300px" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtNome'.$totalSOCIOs, $_SESSION["id_empresaSecao"]))?>" maxlength="200" alt="Nome do novo sócio" onBlur="javascript:mudaNomeSocio(<?=$totalSOCIOs?>)" onKeyUp="javascript:mudaNomeSocio(<?=$totalSOCIOs?>)" />
                              </td>
                          </tr>
                          <tr>
                              <td align="right" valign="middle" class="formTabela">Nacionalidade:</td>
                              <td class="formTabela">
                                  <input name="txtNacionalidade<?=$totalSOCIOs?>" type="text" id="txtNacionalidade<?=$totalSOCIOs?>" style="width:300px" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtNacionalidade'.$totalSOCIOs, $_SESSION["id_empresaSecao"]))?>" maxlength="200" alt="Nacionalidade do novo sócio" />
                              </td>
                          </tr>
                          <tr>
                              <td align="right" valign="middle" class="formTabela">Sexo:</td>
                              <td class="formTabela">
                                  <label style="margin-right:15px"><input type="radio" name="radSexoSocio<?=$totalSOCIOs?>" id="radSexo1Socio<?=$totalSOCIOs?>" value="Masculino" <?=(getDadosContrato('dados_alteracao_contrato', 'radSexoSocio'.$totalSOCIOs, $_SESSION["id_empresaSecao"]) == 'Masculino' ? 'CHECKED' : '')?> /> Masculino</label>
                                  <label><input type="radio" name="radSexoSocio<?=$totalSOCIOs?>" id="radSexo2Socio<?=$totalSOCIOs?>" value="Feminino" <?=(getDadosContrato('dados_alteracao_contrato', 'radSexoSocio'.$totalSOCIOs, $_SESSION["id_empresaSecao"]) == 'Feminino' ? 'CHECKED' : '')?> /> Feminino</label>
                              </td>
                          </tr>
                          <tr>
                              <td align="right" valign="middle" class="formTabela">Estado Civil:</td>
                              <td class="formTabela">
                                  <input name="txtEstadoCivil<?=$totalSOCIOs?>" type="text" id="txtEstadoCivil<?=$totalSOCIOs?>" style="width:300px" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtEstadoCivil'.$totalSOCIOs, $_SESSION["id_empresaSecao"]))?>" maxlength="200" alt="Estado Civil do novo sócio"/>
                              </td>
                          </tr>
                          <tr>
                              <td align="right" valign="middle" class="formTabela">Profissão:</td>
                              <td class="formTabela">
                                  <input name="txtProfissao<?=$totalSOCIOs?>" type="text" id="txtProfissao<?=$totalSOCIOs?>" style="width:300px" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtProfissao'.$totalSOCIOs, $_SESSION["id_empresaSecao"]))?>" maxlength="200" alt="Profissão do novo sócio"/>
                              </td>
                          </tr>
                          <tr>
                              <td align="right" valign="middle" class="formTabela">CPF</td>
                              <td class="formTabela">
                                  <input name="txtCPF<?=$totalSOCIOs?>" type="text" id="txtCPF<?=$totalSOCIOs?>" style="width:125px" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtCPF'.$totalSOCIOs, $_SESSION["id_empresaSecao"]))?>" maxlength="14" alt="CPF do novo sócio" /><span style="font-size:10px">Ex.: 999.999.999-99</span>
                              </td>
                          </tr>
                          <tr>
                              <td align="right" valign="middle" class="formTabela">RG:</td>
                              <td class="formTabela">
                                  <input name="txtRG<?=$totalSOCIOs?>" type="text" id="txtRG<?=$totalSOCIOs?>" style="width:300px" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtRG'.$totalSOCIOs, $_SESSION["id_empresaSecao"]))?>" maxlength="17" alt="RG do novo sócio" />
                              </td>
                          </tr>
                          <tr>
                              <td align="right" valign="middle" class="formTabela">Orgão Expeditor:</td>
                              <td class="formTabela">
                                  <input name="txtOrgaoExpedidor<?=$totalSOCIOs?>" type="text" id="txtOrgaoExpedidor<?=$totalSOCIOs?>" style="width:300px" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtOrgaoExpedidor'.$totalSOCIOs, $_SESSION["id_empresaSecao"]))?>" maxlength="250" alt="Orgão Expeditor do novo sócio" />
                              </td>
                          </tr>
                          <tr>
                              <td align="right" valign="middle" class="formTabela">Endere&ccedil;o:</td>
                              <td class="formTabela">
                                  <input name="txtEnderecoSocio<?=$totalSOCIOs?>" id="txtEnderecoSocio<?=$totalSOCIOs?>" type="text" style="width:300px" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtEnderecoSocio'.$totalSOCIOs, $_SESSION["id_empresaSecao"]))?>" maxlength="250" alt="Endereço do novo sócio" />
                              </td>
                          </tr>
                          <tr>
                              <td align="right" valign="middle" class="formTabela">Bairro:</td>
                              <td class="formTabela">
                                  <input name="txtBairroSocio<?=$totalSOCIOs?>" id="txtBairroSocio<?=$totalSOCIOs?>" type="text" style="width:300px" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtBairroSocio'.$totalSOCIOs, $_SESSION["id_empresaSecao"]))?>" maxlength="200" alt="Complemento do novo sócio" />
                              </td>
                          </tr>
                          <tr>
                              <td align="right" valign="middle" class="formTabela">CEP:</td>
                              <td class="formTabela">
                                  <input name="txtCEPSocio<?=$totalSOCIOs?>" type="text" id="txtCEPSocio<?=$totalSOCIOs?>" style="width:70px" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtCEPSocio'.$totalSOCIOs, $_SESSION["id_empresaSecao"]))?>" maxlength="9" alt="CEP do novo sócio" /><span style="font-size:10px">Ex.: 99999-999</span>
                              </td>
                          </tr>
                          <tr>
                              <td align="right" valign="middle" class="formTabela">Cidade:</td>
                              <td class="formTabela">
                                  <input name="txtCidadeSocio<?=$totalSOCIOs?>" type="text" id="txtCidadeSocio<?=$totalSOCIOs?>" style="width:300px" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtCidadeSocio'.$totalSOCIOs, $_SESSION["id_empresaSecao"]))?>" maxlength="200" alt="Cidade do novo sócio" />
                              </td>
                          </tr>
                          <tr>
                              <td align="right" valign="middle" class="formTabela">Estado:</td>
                ...
                <div id="socio<?=$totalSOCIOs?>">
                    <table border="0" cellpadding="0" cellspacing="3" class="formTabela" style="background:none">
                        ...
                        <tr>
                            <td align="right" valign="middle" class="formTabela">CPF</td>
                            <td class="formTabela">
                                <input name="txtCPF<?=$totalSOCIOs?>" type="text" id="txtCPF<?=$totalSOCIOs?>" style="width:125px" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtCPF'.$totalSOCIOs, $_SESSION["id_empresaSecao"]))?>" maxlength="14" alt="CPF do novo sócio" class="cpf" /><span style="font-size:10px">Ex.: 999.999.999-99</span>
                            </td>
                        </tr>
                        <tr>
                            <td align="right" valign="middle" class="formTabela">RG:</td>
                        ...
                        <tr>
                            <td align="right" valign="middle" class="formTabela">CEP:</td>
                            <td class="formTabela">
                                <input name="txtCEPSocio<?=$totalSOCIOs?>" type="text" id="txtCEPSocio<?=$totalSOCIOs?>" style="width:70px" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtCEPSocio'.$totalSOCIOs, $_SESSION["id_empresaSecao"]))?>" maxlength="9" alt="CEP do novo sócio" class="cep" /><span style="font-size:10px">Ex.: 99999-999</span>
                            </td>
                        </tr>
                        <tr>
                            <td align="right" valign="middle" class="formTabela">Cidade:</td>
...
?>
                        ...
                        <label><input type="checkbox" name="cheAlterarCapitalSocial" id="cheAlterarCapitalSocial" onClick="javascript:abreDiv('capital')" <?=(getDadosContrato('dados_alteracao_contrato', 'cheAlterarCapitalSocial', $_SESSION["id_empresaSecao"]) == 'on' ? 'checked' : '')?> /> 
                        Alteração no Capital Social</label><br />

						<? // 	FORMULARIO DE ALTERAR CAPITAL SOCIAL ?>
                        <div id="capital" style="margin:10px 0 10px 17px ; <?=(getDadosContrato('dados_alteracao_contrato', 'cheAlterarCapitalSocial', $_SESSION["id_empresaSecao"]) == 'on' ? 'display: block' : 'display: none')?>">
                            ...
                            <input class="current" type="text" name="totalReaisFuturo" id="totalReaisFuturo" style="width:60px; margin-bottom:3px" alt="capital social futuro com o valor de cada quota (em reais)" value="<?=(getDadosContrato('dados_alteracao_contrato', 'totalReaisFuturo', $_SESSION["id_empresaSecao"]))?>" /> 
                            Valor de cada cota em Reais<br />
                            <input class="inteiro" type="text" name="totalCotasFuturo" id="totalCotasFuturo" style="width:60px" alt="capital social futuro com o total de cotas" value="<?=(getDadosContrato('dados_alteracao_contrato', 'totalCotasFuturo', $_SESSION["id_empresaSecao"]))?>" /> Total de Cotas
                        </div>



                        
                        <label><input type="checkbox" name="cheAlterarCotas" id="cheAlterarCotas" onClick="javascript:abreDiv('cotas');" <?=(getDadosContrato('dados_alteracao_contrato', 'cheAlterarCotas', $_SESSION["id_empresaSecao"]) == 'on') || (getDadosContrato('dados_alteracao_contrato', 'cheIncluirSocio', $_SESSION["id_empresaSecao"]) == 'on') || (getDadosContrato('dados_alteracao_contrato', 'cheExcluirSocio', $_SESSION["id_empresaSecao"]) == 'on') ? 'checked' : ''?> <?=(getDadosContrato('dados_alteracao_contrato', 'cheIncluirSocio', $_SESSION["id_empresaSecao"]) == 'on') || (getDadosContrato('dados_alteracao_contrato', 'cheExcluirSocio', $_SESSION["id_empresaSecao"]) == 'on') ? 'DISABLED' : ''?> /> Alteração na distribuição de cotas</label><br />

						<? // 	FORMULARIO DE ALTERAR COTAS ?>
                        <div id="cotas" style="margin-left:17px; margin-top:10px; margin-bottom:20px; <?=(getDadosContrato('dados_alteracao_contrato', 'cheAlterarCotas', $_SESSION["id_empresaSecao"]) == 'on' ? 'display:block' : 'display:none')?>">
                            ...
                            while ($linha=mysql_fetch_array($resultado)) {
                            ?>
								<label><input type="checkbox" name="cheSocioTransfere<?=$campo?>" id="cheSocioTransfere<?=$campo?>" onClick="javascript:abreDiv('divSocioTransfereCota<?=$campo?>')" <?=(getDadosContrato('dados_alteracao_contrato', 'cheSocioTransfere'.$campo, $_SESSION["id_empresaSecao"]) == 'on' || getDadosContrato('dados_alteracao_contrato', 'cheSocioExcluso'.$campo, $_SESSION["id_empresaSecao"]) == 'on' ? 'checked' : '')?> /> <?=$linha["nome"]?></label><br />

								<div id="divSocioTransfereCota<?=$campo?>" style="margin-left:17px; margin-bottom:10px; margin-top:10px; <?=(getDadosContrato('dados_alteracao_contrato', 'cheSocioTransfere'.$campo, $_SESSION["id_empresaSecao"]) == 'on' || getDadosContrato('dados_alteracao_contrato', 'cheSocioExcluso'.$campo, $_SESSION["id_empresaSecao"]) == 'on' ? 'display:block' : 'display:none')?>">
									Transfere:
									<?php 
                                    ...
                                    ?>
                                        <div id="divSocio<?=$campo?>TransfereCotaPara<?=$listaSocios?>" style="margin-bottom:3px; display:block">
                                          <input type="text" name="txtSocio<?=$campo?>TransfereCotaPara<?=$listaSocios?>" id="txtSocio<?=$campo?>TransfereCotaPara<?=$listaSocios?>" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtSocio'.$campo.'TransfereCotaPara'.$listaSocios, $_SESSION["id_empresaSecao"]))?>" style="width:60px" class="campoTransfereCotasPara inteiro" pos="<?=$campo?>" /> 
...
?>
                                    ...
                                    <div id="transfereParaNovosSocios<?=$campo?>" style=" <?=(getDadosContrato('dados_alteracao_contrato', 'cheIncluirSocio', $_SESSION["id_empresaSecao"]) == 'on' ? 'display:block' : 'display:none')?>">
        ...
        ?>
                                        <div id="Socio<?=$campo?>novoSocio<?=$listaNovosSocios?>" style="margin-bottom:3px">
                                            <input name="txtSocio<?=$campo?>TransfereCotaParaNovo<?=$listaNovosSocios?>" id="txtSocio<?=$campo?>TransfereCotaParaNovo<?=$listaNovosSocios?>" type='text' style='width:60px; float:left' value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtSocio'.$campo.'TransfereCotaParaNovo'.$listaNovosSocios, $_SESSION["id_empresaSecao"]))?>" class="campoTransfereCotasPara inteiro" pos="<?=$campo?>" />
        ...
        <?	
                                    ...
                                    <input type="hidden" name="hidTotalSocio<?=$campo?>Transfere" id="hidTotalSocio<?=$campo?>Transfere" value="<?=(getDadosContrato('dados_alteracao_contrato', 'hidTotalSocio'.$campo.'Transfere', $_SESSION["id_empresaSecao"]))?>" alt="<?=$linha["nome"]?>" />
...
<br />
                            ...
                            ?>
                                ...
                                <div id="divDistribuicaoFuturaSocio<?=$listaSocios?>" style="margin-bottom:3px; display:block">
                                    <input class="inteiro" type="text" name="txtDistribuicaoFuturaSocio<?=$listaSocios?>" id="txtDistribuicaoFuturaSocio<?=$listaSocios?>" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtDistribuicaoFuturaSocio'.$listaSocios.'', $_SESSION["id_empresaSecao"]))?>" style="width:60px" alt="distribuição societária futura com as quotas de <?=$linha["nome"]?>" /> 
							...
							$listaNovosSocios = 1;
?>
                            <div id="distribuicaoParaNovoSocio" style=" <?=(getDadosContrato('dados_alteracao_contrato', 'cheIncluirSocio', $_SESSION["id_empresaSecao"]) == 'on' ? 'display:block' : 'display:none')?>">
<?
							if(mysql_num_rows($novoSocio) > 0){
								// MONTAR A LISTA DE CAMPOS DE TEXTO PARA PREENCHIMENTO DE QUOTAS
								while ($rsNovoSocio=mysql_fetch_array($novoSocio)) {
?>
                                <div id="divDistribuicaoFuturaNovoSocio<?=$listaNovosSocios?>" style="margin-bottom:3px">
                                    <input class="inteiro" name="txtDistribuicaoFuturaNovoSocio<?=$listaNovosSocios?>" id="txtDistribuicaoFuturaNovoSocio<?=$listaNovosSocios?>" type='text' style='width:60px; float:left' value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtDistribuicaoFuturaNovoSocio'.$listaNovosSocios, $_SESSION["id_empresaSecao"]))?>">
...
<?
								...
								while ($linha=mysql_fetch_array($resultado)) {
?>
                                <div id="divAdministracaoFuturaSocio<?=$listaSocios?>" style="display:<?=getDadosContrato('dados_alteracao_contrato', 'cheSocioExcluso'.$listaSocios.'', $_SESSION["id_empresaSecao"]) == 'on' ? 'none' : 'block'?>">
                                    <label><input type="checkbox" name="cheAdministracaoSocio<?=$listaSocios?>" id="cheAdministracaoSocio<?=$listaSocios?>" <?=(getDadosContrato('dados_alteracao_contrato', 'cheAdministracaoSocio'.$listaSocios, $_SESSION["id_empresaSecao"]) == 'on' ? 'checked' : '' )?> /> <?=$linha["nome"]?></label>
                                </div>
...
?>
                        <div id="AdministracaoParaNovoSocio" style=" <?=(getDadosContrato('dados_alteracao_contrato', 'cheIncluirSocio', $_SESSION["id_empresaSecao"]) == 'on' ? 'display:block' : 'display:none')?>">
<?							
						if(mysql_num_rows($novoSocio)>0){
...
?>
                                <div id="divAdministracaoNovoSocio<?=$listaNovosSocios?>">
                                    <label><input name="cheAdministracaoNovoSocio<?=$listaNovosSocios?>" id="cheAdministracaoNovoSocio<?=$listaNovosSocios?>" type='checkbox' style='float:left' <?=(getDadosContrato('dados_alteracao_contrato', 'cheAdministracaoNovoSocio'.$listaNovosSocios, $_SESSION["id_empresaSecao"]) == 'on' ? 'checked' : '' )?> />
...
<?
$cidade = getDadosCliente('dados_da_empresa', 'cidade', $_SESSION["id_empresaSecao"]);
$estado = getDadosCliente('dados_da_empresa', 'estado', $_SESSION["id_empresaSecao"]);

$comarca = getDadosContrato('dados_alteracao_contrato', 'txtComarca', $_SESSION["id_empresaSecao"]);
$UFcomarca = getDadosContrato('dados_alteracao_contrato', 'selUFComarca', $_SESSION["id_empresaSecao"]);
...
?>
            ...
            <div style="clear:both; height: 20px;"></div>
                        ...
                        <table border="0" cellpadding="0" cellspacing="3" class="formTabela" style="background:none">
                            <tr>
                                <td align="right" valign="middle" class="formTabela">Nome:</td>
                                <td class="formTabela" width="300"><input name="txtNomeTest1" type="text" id="txtNomeTest1" style="width:300px" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtNomeTest1', $_SESSION["id_empresaSecao"]))?>" maxlength="200" alt="Nome da Testemunha 1" /></td>
                            </tr>
                            <tr>
                                <td align="right" valign="middle" class="formTabela">RG:</td>
                                <td class="formTabela"><input name="txtRGTest1" type="text" id="txtRGTest1" style="width:300px" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtRGTest1', $_SESSION["id_empresaSecao"]))?>" maxlength="17" alt="RG da Testemunha 1" /></td>
                            </tr>
                            <tr>
                                <td align="right" valign="middle" class="formTabela">Orgão Expeditor:</td>
                                <td class="formTabela"><input name="txtOrgaoExpedidorTest1" type="text" id="txtOrgaoExpedidorTest1" style="width:300px" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtOrgaoExpedidorTest1', $_SESSION["id_empresaSecao"]))?>" maxlength="250" alt="Orgão Expedidor da Testemunha 1" /></td>
                            </tr>
                        </table>
                        <br />
                        ...
                        <table border="0" cellpadding="0" cellspacing="3" class="formTabela" style="background:none">
                            <tr>
                                <td align="right" valign="middle" class="formTabela">Nome:</td>
                                <td class="formTabela" width="300"><input name="txtNomeTest2" type="text" id="txtNomeTest2" style="width:300px" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtNomeTest2', $_SESSION["id_empresaSecao"]))?>" maxlength="200" alt="Nome da Testemunha 2" /></td>
                            </tr>
                            <tr>
                                <td align="right" valign="middle" class="formTabela">RG:</td>
                                <td class="formTabela"><input name="txtRGTest2" type="text" id="txtRGTest2" style="width:300px" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtRGTest2', $_SESSION["id_empresaSecao"]))?>" maxlength="17" alt="RG da Testemunha 2" /></td>
                            </tr>
                            <tr>
                                <td align="right" valign="middle" class="formTabela">Orgão Expeditor:</td>
                                <td class="formTabela"><input name="txtOrgaoExpedidorTest2" type="text" id="txtOrgaoExpedidorTest2" style="width:300px" value="<?=(getDadosContrato('dados_alteracao_contrato', 'txtOrgaoExpedidorTest2', $_SESSION["id_empresaSecao"]))?>" maxlength="250" alt="Orgão Expedidor da Testemunha 2" /></td>
                            </tr>
                        </table>
                        <br />
...
$(document).ready(function(e) {
	...
	$('input[id^="txtCodigoCNAE"]').each(function(index,element){
		var 
			$campo 	= $(this)
			, $div		= $campo.attr('div')
			, $campoCheck		= $('#' + $campo.attr('check'))
...
//		consultaBanco('meus_dados_empresa_consulta_cnae.php?codigo='+$('#txtCodigoCNAE' + i).val(), 'atividade' + i)
	//}
		...
		<?
			...
			} // FIM DO IF if((int)mysql_num_rows($resultado) > 0){
