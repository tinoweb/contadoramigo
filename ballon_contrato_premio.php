...
//	$contador->setSex('M');
	...
	$contrato = "<p>".$CONTRATADA."</p>"
			   ...
			   ."<p>
					...
					4.2. Para a execução dos serviços constantes da cláusula 1 </a CONTRATANTE/> pagará </à CONTRATADA/> os honorários profissionais correspondentes a <span class='ValorPagoContratado'>63</span> mensais por empresa. A cobrança será feita por intermédio da ferramenta de e-commerce do portal Contador Amigo.
				</p><p>
...
<!--CONTRATO -->
<div class="quadro_branco" id="contrato_premio" style="padding: 0px; width: 500px; height: 470px; position: absolute; left: 50%; margin-left: -223px; top: 150px; display: none; z-index: 999; background: rgb(245, 246, 247) none repeat scroll 0% 0%;">
    <div style="text-align:right; margin-right:12px; margin-top:15px">
    	<!--<a href="javascript:fechaDiv('contrato_premio')"><img src="images/x.png" width="8" height="9" border="0" alt="fechar contrato" title="fechar contrato" /></a>-->
        <a id="btPremiumFecha">
    ...
    <div style='padding: 10px 15px; text-align:left;'>
        ...
        <input id="certificadoDigital" name="certificadoDigital" type="checkbox">&nbsp;&nbsp;Já disponho de um Certificado Digital E-CNPJ ativo.
        <br><br>
    	<button id="btPremiumProsseguir" >Prosseguir</button>
    </div>    
</div>
