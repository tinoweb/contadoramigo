...
//$sql = "UPDATE dados_do_responsavel SET nome='$Nome', cpf='$CPF', rg='$RG', data_de_emissao='$DataEmissao', orgao_expeditor='$OrgaoExpedidor', data_de_nascimento='$DataNascimento', endereco='$Endereco', bairro='$Bairro', cep='$CEP', cidade='$txtCidade', estado='$Estado', pref_telefone='$PrefixoTelefone', telefone='$Telefone', codigo_cbo='$CodigoCBO', pro_labore='$ProLabore', nit='$Nit' WHERE idSocio='$SocioID'";
$sql = "UPDATE dados_do_responsavel SET nome='$Nome', cpf='$CPF', rg='$RG', data_de_emissao='$DataEmissao', orgao_expeditor='$OrgaoExpedidor', data_de_nascimento='$DataNascimento', endereco='$Endereco', bairro='$Bairro', cep='$CEP', cidade='$txtCidade', estado='$Estado', pref_telefone='$PrefixoTelefone', telefone='$Telefone', codigo_cbo='$CodigoCBO', nit='$Nit' WHERE idSocio='$SocioID'";
