...
if(isset($_REQUEST['agendar'])){
	...
	*/
	...
	//		echo "AGENDANDO ENVIO DE MENSAGEM DE Demo Inativo<BR>";
	//		ob_flush();
...
?>
  ...
  <div class="titulo" style="margin-bottom:10px;">Listas E-mail Marketing</div>
...
?>
  <table border="0" cellspacing="2" cellpadding="4" style="margin-top: 20px; width: 50%;">
      <tr>
...
?>
    ...
    <div style="width: 100%; text-align:center; margin: 20px auto 0 auto;"><input type="button" value="Agendar Envios" onClick="location.href='listas_emailmarketing.php?agendar'"></div>
<?
	} else {
?>
