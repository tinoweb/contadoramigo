...
<div class="principal">
<div class="titulo">Balanço patrimonial</div>
...
<br>
Sem declarar balanço, você fica limitado a tirar como lucro apenas 32% (menos IR) do faturamento bruto, se for um prestador de serviço e 8% se for comerciante. O restante só pode ir para a pessoa física na forma de pró-labore e está sujeito a INSS e Imposto de Redna na Fonte.<br>
<br>
Mas para que o balanço tenha validade, deverá auditado por um contador e registrado na Jucesp. O Contador Amigo dispõe de um contabilista perceiro que poderá fazer isso para você. O valor desde serviço é cobrado conforme a tabela a seguir:<br>
<br>
...
Mesmo que não pretenda submeter a um contador ou registrá-lo, você poderá gerar o balanço nesta ferramenta e usá-lo para sua própria análise. O balanço contém informações muito relevantes para a empresa que poderão ajudá-lo em seu planejamento para o futuro.<br>
<br>

	<div class="tituloVermelho">Atualize o Livro Caixa</div>
...
<br>
Em seguida, preencha cuidadosamente os campos a seguir, e anexe os respectivos comprovantes (eles são necessários para que o balanço possa ser auditado pelo contador). Em caso de dúvida, consulte nosso <a href="suporte.php">Help desk</a>. 
<br>
<br>
<br>
...
<!--		<table id="itens_emprestimos" border="0" cellspacing="2" cellpadding="4" class="formTabela" style="width:966px">
		  	<tbody>
			  	<tr>
	       			<th align="center" width="380">Descrição</th>
	       			<th align="center" >Data</th>
	       			<th align="center" >Valor</th>
	       			<th align="center" >Carência</th>
	       			<th align="center" width="110">Saldo a pagar</th>
	       			<th align="center" width="100">Comprovante</th>
	    		</tr>
...
<script>
	$( document ).ready(function() {
		...
		$(".atualizarAno").change(function() {
			$("#ano").val($(this).val());
			location = 'balanco-patrimonial-form.php?ano='+$(this).val();
		});
