			...
			foreach($dados as $val) {
				...
				if($val->getLoginStatus() != 'servico-avulso'){
					$linkEntrar = '	<td class="td_calendario" align="left" data-logStatus="'.$val->getLoginStatus().'">'
						...
						.'			<button class="gridButton" type="submit" style="color: #3D6D9E; text-decoration: underline; background: none; padding: 5px"><i class="fa fa-angle-double-right iconesAzuis iconesMed"></i></button>'
						.'		</form> '
						.'	</td>';
				} else {
