...
*/
  ...
  <tr>
    <td colspan="2" valign="middle" class="formTabela"><input type="hidden" name="hidID" id="hidID" value="<?php if( $linha["id"] == '' ) echo $_GET['id']; else echo $linha["id"]; ?>" /></td>
  </tr>
  <tr>
