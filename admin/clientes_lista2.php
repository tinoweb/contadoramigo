...
<span style="margin-right:10px"> <strong>Total de <?=$labelFiltro?>:</strong> <?=$qtd?></span>
...
-->
  ...
  <table border="0" cellspacing="2" cellpadding="4" style="font-size:12px" width="100%">
    ...
    <? } else { ?>
      <th align="center" width="45%">Assinante <small>(nº de empresas)</small></th>
      <th align="center" width="45%">Email</th>
      <th align="center" width="10%">Ação</th>
    <? } ?>
...
//echo $paginaAtual . "<BR>";
//echo $totalPesquisado . "<BR>";
//echo $quantidadeResultados . "<BR>";
//echo ceil($totalPesquisado / $quantidadeResultados) . "<BR>";
