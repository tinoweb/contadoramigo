...
<table border="0" cellspacing="2" cellpadding="4" style="font-size:11px;" width="100%">
    ...
    <th width="31%" align="center">Assinante</th>
...
//						 ,'certificado'=>'Certificado Digital');
				...
				// Array criado para normalizar o nome dos tipo.			
			$arrayTipo = array('Standard'=>'Standard'
						 ,'Premium'=>'Premium'
						 ,'ComplementarPremium'=>'Complementar');
...
//			}
		...
		switch ($linha["resultado_acao"]){
			...
			case '11.2': $resultado_acao = ($linha["tipo_cobranca"] == 'boleto' ? 'Boleto com sucesso' : 'Cartão com sucesso'); break;
			case '11.3': $resultado_acao = ($linha["tipo_cobranca"] == 'boleto' ? 'Boleto com sucesso' : 'Cartão com sucesso'); break;
			case '11.4': $resultado_acao = ($linha["tipo_cobranca"] == 'boleto' ? 'Boleto com sucesso' : 'Cartão com sucesso'); break;
		}	
