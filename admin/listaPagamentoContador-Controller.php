	...
	if($cobrancaContador) {
		...
		$tagTable = '<table class="tablePagamento" style="width: 100%; margin-bottom: 10px;" cellpadding="5" cellspacing= "0"> 
					<tr>         	
						...
						<th style="width:10%; text-align: center;">A Receber</th>
						<th style="width:10%; text-align: center;">Valor Pago</th>
						<th style="width:10%; text-align: center;">Saldo</th>
						<th style="width:6%; text-align: center;">nº NF</th>
					</tr>
					'.$tagTR.'
				</table>';
