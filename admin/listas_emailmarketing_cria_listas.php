...
?>
  ...
  <div class="titulo" style="margin-bottom:10px;">Cria as Lista do Emkt</div>
  <div style="clear:both;"> </div>
...
?>
    ...
    <div style="width: 100%; text-align:left; margin: 20px auto 0 auto;"><!--<input type="button" value="Agendar Envios" onClick="location.href='listas_emailmarketing.php?agendar'">-->
		<input type="button" value="Criar Lista" onClick="location.href='listas_emailmarketing.php?agendar'">
