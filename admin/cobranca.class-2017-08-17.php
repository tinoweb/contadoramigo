<?php 
	...
	class Cobranca_boleto{
		...
		function inserirRelatorioCobranca(){
			...
			$campos = "(id,  idHistorico, data, data_pagamento, tipo_cobranca, resultado_acao, envio_email, valor_pago, emissao_NF, tipo_plano, plano, observacao)";
			$values = "(	
							'" . $this->getid_user() . "', 
							...
							'". $this->gettipo_plano() ."',
							'". $this->getplano_user() ."',
							'Boleto registro linha: 306 ".$this->getnosso_numero()."'
						)";
			...
			// Esta condição foi criada para normalizar o pagamento que retorna do banco do brasil com o juros sendo calculado por ele.
