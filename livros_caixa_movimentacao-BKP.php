...
//	error_reporting(E_ALL);
	...
	require_once('Controller/livros_caixa_movimentacao-controller-BKP.php');
...
//echo $descricao_colunas_tabela['Field'];
			...
			if ($linha["saida"] != 0) {
										//	echo str_replace(".",",",$linha["saida"]);
												$valor = number_format($linha["saida"],2,',','.');
												$lancamento = 'saida';
											}
											else {
									//	echo str_replace(".",",",$linha["entrada"]);
												$valor = number_format($linha["entrada"],2,',','.');
												$lancamento = 'entrada';
											}		
							...
							<table border="0" cellspacing="2" cellpadding="4" width="966" style="font-size: 11px;">
								...
								<tbody>
									<tr>
										...
										<td class="td_calendario"><input name="txtValor" id="txtValor" type="text" value="<?php echo $valor;?>" style="width:100px;font-size:12px !important;" class="current" />
										</td>										   
