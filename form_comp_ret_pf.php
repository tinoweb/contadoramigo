...
$pdf->Image('images/brasao_pb.png',12,11,15); // IMAGEM DO BRAZAO

$pdf->SetFont('arial','B',8); // SELECIONANDO FONTE PARA O HEADER ESQUERDO
$pdf->Cell(95,18,'','LTRB','L',1);// CELULA QUE ENVOLVE O TEXTO DA ESQUERDA
$pdf->Cell(95,18,'','TRB','L',1);// CELULA QUE ENVOLVE O TEXTO DA ESQUERDA
$pdf->SetXY(45,9); // POSICIONANDO PARA ESCREVER
...
$pdf->SetXY(10,33);// POSICIONANDO PARA ESCREVER
$pdf->Write(3,utf8_decode("Verifique as condições e o prazo para a apresentação da Declaração do Importo sobre a Renda da Pessoa Física para este ano-calendário no sítio da Secretaria da Receita Federal do Brasil na internet, no endereço <www.receita.fazenda.gov.br>.")); // ESCREVENDO ULTIMA LINHA DO HEADER DIREITO
$pdf->Ln(5.5);
...
$pdf->SetFont('arial','',8);
$pdf->SetXY(10,48);// POSICIONANDO PARA ESCREVER
$pdf->Write(5,utf8_decode($cnpj));
$pdf->SetXY(60,48);// POSICIONANDO PARA ESCREVER
...
$pdf->SetXY(10,58.5);// POSICIONANDO PARA ESCREVER
$pdf->Write(5,utf8_decode("CPF"));
$pdf->SetXY(60,58.5);// POSICIONANDO PARA ESCREVER
$pdf->Write(5,utf8_decode("Nome completo"));
$pdf->SetXY(10,65.5);// POSICIONANDO PARA ESCREVER
$pdf->Write(5,utf8_decode("Natureza do rendimento"));

// PREENCHENDO OS DADOS DO AUTONOMO
$pdf->SetFont('arial','',8);
$pdf->SetXY(10,61.5);// POSICIONANDO PARA ESCREVER
$pdf->Write(5,utf8_decode($linha_dados['cpf']));
$pdf->SetXY(60,61.5);// POSICIONANDO PARA ESCREVER
$pdf->Write(5,utf8_decode($linha_dados['nome']));
$pdf->SetXY(10,69.5);// POSICIONANDO PARA ESCREVER
$pdf->Write(5,utf8_decode(($tipo == 'sócio' ? 'Rendimentos do trabalho assalariado' : $linha_dados['tipo_servico'])));
$pdf->SetXY(10,69.5);// VOLTANDO O POSICIONAMENTO DO CURSOR PARA O ADEQUADO AO LAYOUT
$pdf->Ln(8);
