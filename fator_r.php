...
<div class="principal">
  ...
  Para conhecer o Fator R, acesse o <a href="https://www.receita.fazenda.gov.br/eCAC" target="_blank">E-Cac</a>, com seu certificado digital. Vá em Simples Nacional, clique no item &quot;PGDAS-D - a partir de 01/2012&quot; e proceda da seguinte forma:
  </div>
...
<br />
<br />
O PDF do extrato será baixado em seu micro. Abra-o e procure o <strong>Fator R</strong>, no local indicado na figura abaixo. Após localizar o índice, retorne à <a href="impostos_aliquotas_calcula.php">página de cálculo das alíquotas dos impostos</a> para informá-lo. Se o extrato não apresentar o fator R. Experimente abrir o de outros meses. Se não tiver sucesso, entre em contato com o nosso Help Desk.
<br /><br />
<img src="images/fator_r3.png" width="70%" height="60%" style="border-color:#CCC; border-width:1px; border-style:solid" />
</div>
