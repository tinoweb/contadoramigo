	...
	$(function(){
		...
		$('#btPremiumProsseguir').click(function() {
			...
			if($("#termoPremium").is(':checked')) {
				...
				if($('#certificadoDigital').is(':checked')) {
					statuschecked = true;
				} else {
					statuschecked = false;
					alert('Marque a opção "Já disponho de um Certificado Digital E-CNPJ ativo". Não será possível assinar o Plano Premium sem o certificado.');
				}
