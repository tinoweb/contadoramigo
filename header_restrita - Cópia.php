...
<!--  <li>|</li>-->
		<li class="hasChild"><a class="linkMenu" href="#">Consultar Dívidas</a>
		  <div class="linha-branca-menu"></div>
		  <ul style="width: 230px !important;">
		    <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="situacao_fiscal.php">Situação fiscal</a></li>
...
<!--  <li>|</li>-->
  ...
  <li><a class="linkMenu" href="servico-contador.php">Serviços Avulsos</a></li>
	...
	<li class="hasChild"><a class="linkMenu" href="#">Outros</a>
	  <div class="linha-branca-menu"></div>
	  <ul style="width: 230px !important;">
    	    <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="certidao-negativa.php">Certidões Negativas</a></li>
	    <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="declaracao_simples.php">Declaração do Simples</a></li>
	    <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="pis.php">Número do PIS</a></li>
        ...
        <li><img src="images/seta_opcoes.png"/>&nbsp;&nbsp;<a class="linkMenu"  href="servico-contador.php">Serviços com Contador</a></li>
        
       	<?php if( $tipoPlano == 'P' ):?>
	<!--    <li><img src="images/seta_opcoes.png"/><a class="linkMenu"  href="lista-funcionario-holerite.php">Folha de Ponto</a></li>-->	    
	    <?php endif;?>
