<?php 
	class Gerar_DRE{
		...
		private $resultado_operacional_antes_resultado;
		...
		function getAgrupamentoDespesas($string){
			...
			if( $string == 'Marketing e publicidade' ) return "outras_despesas_gerais";
			...
			// Preserva ate Verifiar a Revisão do Banco.
			//if( $string == 'Juros' ) {return "despesas_financeiras";}
			if( $string == 'Despesas bancárias' ) {return "despesas_financeiras";}
			
			if( $string == 'Licença de Software' || $string == 'Licença ou aluguel de softwares' ){
				if($this->defineDREDeAcordoCNAE($cnae, $string) == 1){
					return "custo_dos_servicos_prestados";
				} else {
					return "despesas_administrativas";
...
//			if( $string == 'Pgto. de salários' ) return "despesas_com_pessoal";
		...
		function calcularItens(){
			...
			// Calcula 	
			$this->array_total['outras_despesas_gerais'] = $this->array_total['outras_despesas_gerais'];
			...
			$this->array_total['despesas_operacionais'] = $this->array_total['despesas_administrativas'];
			$this->array_total['despesas_operacionais'] += $this->array_total['outras_despesas_gerais'];
			...
			$this->array_total['resultado_operacional_antes_resultado'] = $this->array_total['lucro_bruto'] + $this->array_total['despesas_operacionais'];
		}
		function gerarDre(){
				...
				<table border="0" cellspacing="2" cellpadding="4" style="width:840px;font-size: 11px;margin-top: -2px;float:left;margin-bottom:30px;">
					<tbody>
						<tr>
			       			...
			       			<th style="width:180px;font-size: 12px;" align="center">R$</th>
			    		</tr>	
			    		<tr>
							<td class="td_calendario agrupado titulo_tabela">VENDAS DE PRODUTOS, MERCADORIAS E SERVIÇOS </td>
							<td class="td_calendario agrupado titulo_tabela" align="right"></td>
						</tr>
						<tr>
							<td class="td_calendario">Vendas de Produtos, Mercadorias e Serviços</td>
							<td class="td_calendario" align="right">'.$this->getvendas_de_mercadorias_produtos_e_servicos().'</td>
						</tr>
						<tr>
							<td class="td_calendario">(-) Deduções de Tributos, Abatimentos e Devoluções</td>
							<td style="width:180px;" class="td_calendario" align="right">'.str_replace('-','',$this->getdeducoes_com_impostos_devolucoes_e_descontos()).'</td>
						</tr>
						<tr>
							<td style="width:650px;" class="td_calendario agrupado titulo_tabela">= RECEITA LÍQUIDA</td>
							<td style="width:180px;" class="td_calendario agrupado titulo_tabela" align="right">'.$this->getreceita_liquida().'</td>
						</tr>
					</tbody>
				</table>
			';
				...
				<table border="0" cellspacing="2" cellpadding="4" style="width:840px;font-size: 11px;margin-top: -2px;float:left;margin-bottom:30px;">
					<tbody>
						<tr>
							...
							<td style="width:180px;" class="td_calendario agrupado titulo_tabela" align="right"></td>
						</tr>
						<tr>
							<td class="td_calendario">Custo dos Produtos, Mercadorias e Serviços</td>
							<td class="td_calendario" align="right">'.str_replace('-','',$this->getcusto_das_vendas()).'</td>
						</tr>
					</tbody>
				</table>
			';
				...
				<table border="0" cellspacing="2" cellpadding="4" style="width:840px;font-size: 11px;margin-top: -2px;float:left;margin-bottom:30px;">
					<tbody>
						<tr>
							...
							<td style="width:180px;" class="td_calendario agrupado titulo_tabela" align="right">'.$this->getlucro_bruto().'</td>
						</tr>
					</tbody>
				</table>
			';
				...
				<table border="0" cellspacing="2" cellpadding="4" style="width:840px;font-size: 11px;margin-top: -2px;float:left;margin-bottom:30px;">
					<tbody>
						...
						<tr>
							...
							<td style="width:180px;" class="td_calendario agrupado titulo_tabela" align="right">'.str_replace('-','',$this->getdespesas_operacionais()).'</td>
						</tr>
						<tr>
							<td class="td_calendario">Despesas Administrativas</td>
							<td class="td_calendario" align="right">'.str_replace('-','',$this->getdespesas_administrativas()).'</td>
						</tr>
						<tr>
							<td class="td_calendario">Despesas com Vendas</td>
							<td class="td_calendario" align="right">'.str_replace('-','',$this->getdespesas_de_vendas()).'</td>
						</tr>
						<tr>
							<td class="td_calendario">Outras Despesas Gerais</td>
							<td class="td_calendario" align="right">'.str_replace('-','',$this->getoutras_despesas_gerais()).'</td>
						</tr>
					</tbody>
				</table>
			';
...
FINANCEIRO</td>
							<td style="width:180px;" class="td_calendario agrupado titulo_tabela" align="right">'.$this->getresultado_operacional_antes_resultado().'</td>
						</tr>
					</tbody>
				</table>
			';			
				...
				<table border="0" cellspacing="2" cellpadding="4" style="width:840px;font-size: 11px;margin-top: -2px;float:left;margin-bottom:30px;">
					<tbody>
						<tr>
							...
							<td style="width:180px;" class="td_calendario agrupado titulo_tabela" align="right">'.str_replace('-','',$this->getresultado_financeiro()).'</td>
						</tr>
						<tr>
							<td class="td_calendario">Receitas Financeiras</td>
							<td class="td_calendario" align="right">'.str_replace('-','',$this->getreceitas_financeiras()).'</td>
						</tr>
						<tr>
							<td class="td_calendario">(-) Despesas Financeiras</td>
							<td class="td_calendario" align="right">'.str_replace('-','',$this->getdespesas_financeiras()).'</td>
						</tr>
					</tbody>
				</table>
			';
				...
				<table border="0" cellspacing="2" cellpadding="4" style="width:840px;font-size: 11px;margin-top: -2px;float:left;margin-bottom:30px;">
					<tbody>
						<tr>
							...
							<td style="width:180px;" class="td_calendario agrupado titulo_tabela" align="right">'.$this->getoutras_receitas_e_despesas_operacionais().'</td>
						</tr>
					</tbody>
				</table>
			';
...
SOBRE O LUCRO</td>
							<td style="width:180px;" class="td_calendario agrupado titulo_tabela" align="right">0,00</td>
						</tr>
						<tr>
							<td class="td_calendario">(-) Despesa com Contribuição Social (*)</td>
							<td class="td_calendario" align="right">0,00</td>
						</tr>
						<tr>
				...
				<table border="0" cellspacing="2" cellpadding="4" style="width:840px;font-size: 11px;margin-top: -2px;float:left;margin-bottom:30px;">
					<tbody>
						<tr>
							...
							<td style="width:180px;" class="td_calendario agrupado titulo_tabela total_dre" align="right">'.$this->getresultado_liquido_do_exercicio().'</td>
						</tr>
		...
		function __construct(){
			...
			$this->setresultado_operacional_antes_resultado(0);
		}
		function getano(){
			return $this->ano;
		}
		...
		function getresultado_operacional_antes_resultado(){
			return number_format($this->array_total['resultado_operacional_antes_resultado'], 2 , ',' , '.' );
		}
		function setresultado_operacional_antes_resultado($string){
			$this->array_total['resultado_operacional_antes_resultado'] = $string; 
		}
