...
/* *** CABECALHO *** */
#instr_header {
	/*background: url('https://www.contadoramigo.com.br/images/logo.png') no-repeat top left;*/
	/*padding-left: 160px;*/
	height: 65px;
}
#instr_header h1 {
...
<div id="container">
	...
	<div id="instr_header">
		...
		<a id="Img_btFechar" title="Fechar Janela" href="javascript:closeWindow();"><img title="Fechar Janela" src="https://comercio.locaweb.com.br/LocaWebCE/boleto/images/bt_fechar.gif" style="border-width:0px;float:right"></a>		
...
<!--
 ...
 -->
		...
		<div id="instr_content">
			<center>
				<h2>Instru&ccedil;&otilde;es de impressão</h2>
				<ol>
