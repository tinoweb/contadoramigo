<?php 
	...
	function getBotaoPagar($string,$data_pagamento,$valor_cobrar){
		if($string == 'boleto'){
		    ...
		    $data_proximo_pagamento = date("2016-09-30");//date('Y-m-d', strtotime(date("Y-m-d"). ' + 2 days'));
