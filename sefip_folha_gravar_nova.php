...
$sql2 = "SELECT * FROM dados_do_responsavel WHERE id='" . $_SESSION["id_empresaSecao"] . "' AND responsavel='1' LIMIT 0, 1";
...
$sql3 = "SELECT cnae FROM dados_da_empresa_codigos WHERE id='" . $_SESSION["id_empresaSecao"] . "' AND tipo='1' LIMIT 0, 1";
$resultado3 = mysql_query($sql3) or die (mysql_error());
$linha_codigo=mysql_fetch_array($resultado3);

if($linha_codigo['cnae'] == ''){
