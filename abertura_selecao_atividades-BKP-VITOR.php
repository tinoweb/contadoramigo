...
<div class="principal">
  ...
  <div class="tituloVermelho">Seleção de Atividades </div>
    ...
    Para escolher as atividades <b>principal e secundárias</b> de sua  empresa, seja para a abertura ou para alteração, faça uma pesquisa no site do <a href="http://www.cnae.ibge.gov.br/" target="_blank">IBGE/Concla</a>. Lá são informados os códigos CNAE de acordo com a atividade descrita. É o código CNAE que definirá alíquota a ser paga no Simples Nacional.<br>
      <br>
      Se você for <b>Comércio</b> ou <b>Indústria</b>, não há muito o que fazer, pois as tabelas para estes tipos de atividade são uma só, mas se for <b>Prestador de Serviços</b> há 4 tabelas  e, em alguns casos, atividades muito semelhantes aparecem enquadradas em tabelas diferentes. Tente  escolher aquela com a alíquota menor, sem, é claro, desvirtuar-se de sua verdadeira área de atuação, pois pagar imposto sobre a tabela errada é considerado sonegação.<br>
      <br>
      Sua empresa pode desempenhar atividades enquadradas em tabelas diferentes. O Imposto do Simples será calculado
de acordo com o faturamento em cada atividade separadamente.<br><br><br>
    ...
    <table width="346" border="0" cellpadding="5" cellspacing="2">
      <tbody>
        ...
        <tr>
          ...
          <td class="td_calendario">19,5%</td>
          <td class="td_calendario">Serviços</td>
        </tr>
        <tr>
