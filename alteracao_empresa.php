...
Para alterar os dados de sua emrpesa no Cadastro Nacional da Pessoa Jurídica (CNPJ), acesse nosso <a href="orientcoes_dbe.php">tutorial para geração do DBE</a>.<br><br><br>


<h3>Alteração no Estado</h3>
Feito o DBE, você deve dar entrada com o processo de alteração na <strong>Junta Comercial</strong> de seu estado. Excepcionalmente, sociedades uniprofissionais, registradas em cartório, e escritórios de Advocacia, registrados na OAB, devem requerer a alteração diretamente nestes órgãos.<br>
<br>
...
Se você estiver alterando uma sociedade, precisará elaborar redigir o novo contrato social consolidado, com a alteração. Para tal, use o <a href="alteracao_contrato.php">aplicativo de alteração contratual</a>. Se estiver alterando uma <strong>Ereli</strong>, é preciso alterar o Ato Constitutivo. Baixe este <a href="downloads/modelo_eireli_alt.doc" target="_blank">modelo básico de alteração do ato constitutivo</a>.<br /><br />
